...
其余步骤同知乎上文章https://zhuanlan.zhihu.com/p/675502389和https://zhuanlan.zhihu.com/p/675502472，但是build文件夹内并没有出现lib，所以我把路径放到lib64文件夹中，即在配置变量这个步骤中，把路径指定到lib64文件夹，而不是知乎上写的build/lib。
