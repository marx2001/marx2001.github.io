...
首先，我选择之前复现过二维铁磁半导体Janus材料的H-CrSeBr的POSCAR作为起始文件，替换POSCAR中的元素，即可得到H-VSeTe单层的初始结构，然后开始结构优化，不加磁性。我发现，并不能得到正确的结构，最多是得到相近的结构
...
获得文献结构的另一种方法，是寻找这个结构的原始构型，可以询问AI或者找综述文献，比如TiCdO4，市面上的两篇文献均未提供材料的晶格常数等信息，但是这个材料是TiO2演变而来。
