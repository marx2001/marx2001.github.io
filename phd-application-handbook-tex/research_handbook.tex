...
这是一个功能强大的,方便自定义任何参数的,类似于vaspkit的脚本,首先要求你的目录结构如下:\par
...
语言：python；完整代码见附录第 \pageref{code:2:2} 页，共 659 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:2:3} 页，共 71 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:2:4} 页，共 652 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.2.5}
语言：python；完整代码见附录第 \pageref{code:2:5} 页，共 2 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:4:1} 页，共 41 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:4:2} 页，共 41 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:4:3} 页，共 41 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:4:4} 页，共 41 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:4:5} 页，共 42 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:4:6} 页，共 48 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:4:7} 页，共 42 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:4:8} 页，共 42 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:4:9} 页，共 42 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:4:10} 页，共 52 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:5:2} 页，共 40 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:5:3} 页，共 47 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:7:1} 页，共 23 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:7:2} 页，共 28 行。
\end{codeindexbox}
...
种子名:如果提供了种子名字符串,程序将从名为 种子名.win的文件中读取其输入。默认值为 wannier。您也可以等价地提供字符串 种子名.win来代替种子名。\par
...
进程数:替换为您想要使用的处理器数量。\par


请注意,mpirun命令及其命令行选项在您使用的 MPI 实现中可能有所不同:请阅读您的 MPI 手册或咨询您的计算机管理员。\par


同时请注意,这要求 wannier90.x 可执行文件已编译为其并行版本(请遵循 wannier90 发行版主目录下 README.install文件中的说明),并且 MPI 库和二进制文件已正确安装并配置在您的计算机上。\par
...
语言：shell；完整代码见附录第 \pageref{code:8:1} 页，共 4 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.9.1}
语言：shell；完整代码见附录第 \pageref{code:9:1} 页，共 3 行。
\end{codeindexbox}


NBANDS =64 (这个数值是你的CPU数量的整数倍,我是用 64 核提交的),INCAR中加入LWANNIER90=T\par
...
语言：shell；完整代码见附录第 \pageref{code:9:2} 页，共 32 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.9.5}
语言：shell；完整代码见附录第 \pageref{code:9:5} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.9.6}
语言：shell；完整代码见附录第 \pageref{code:9:6} 页，共 2 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:9:7} 页，共 64 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.9.8}
语言：shell；完整代码见附录第 \pageref{code:9:8} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.9.9}
语言：shell；完整代码见附录第 \pageref{code:9:9} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.9.10}
语言：shell；完整代码见附录第 \pageref{code:9:10} 页，共 5 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:9:11} 页，共 64 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:9:12} 页，共 58 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.9.13}
语言：shell；完整代码见附录第 \pageref{code:9:13} 页，共 1 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:11:1} 页，共 64 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:11:2} 页，共 11 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:11:3} 页，共 5 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:11:4} 页，共 6 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:11:5} 页，共 5 行。
\end{codeindexbox}
...
Q4: 我看到in文件中的CONTROL中可以选择是否计算bulkband\_\allowbreak{}calc,结合你刚刚回答的结果,似乎一定要计算bulkband?\par
...
语言：shell；完整代码见附录第 \pageref{code:20:2} 页，共 44 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:20:3} 页，共 12 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:20:4} 页，共 43 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:20:5} 页，共 16 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:20:6} 页，共 55 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:20:7} 页，共 11 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.21.1}
语言：shell；完整代码见附录第 \pageref{code:21:1} 页，共 2 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:21:2} 页，共 9 行。
\end{codeindexbox}
...
假设你已经熟悉wannier90,并且如下方所示准备好文件夹,此为示例中的文件结构,实际上我位于我自己的能带计算的文件夹中运行的命令\par


\begin{codeindexbox}{代码清单 A.21.3}
语言：shell；完整代码见附录第 \pageref{code:21:3} 页，共 16 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:21:4} 页，共 2 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:21:5} 页，共 24 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:21:6} 页，共 2 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:21:7} 页，共 25 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:21:8} 页，共 3 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:21:9} 页，共 79 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:21:10} 页，共 2 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.21.11}
语言：shell；完整代码见附录第 \pageref{code:21:11} 页，共 77 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:21:12} 页，共 2 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:21:13} 页，共 36 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:21:14} 页，共 13 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:21:15} 页，共 13 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:21:16} 页，共 14 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:21:17} 页，共 2 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:21:20} 页，共 43 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:21:21} 页，共 2 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:21:22} 页，共 2 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:21:23} 页，共 2 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:22:1} 页，共 21 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:22:2} 页，共 2 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:22:3} 页，共 2 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:22:4} 页，共 2 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:22:5} 页，共 2 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:22:6} 页，共 2 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:22:7} 页，共 2 行。
\end{codeindexbox}
...
语言：fortran；完整代码见附录第 \pageref{code:23:1} 页，共 2052 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.23.2}
语言：fortran；完整代码见附录第 \pageref{code:23:2} 页，共 291 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.24.1}
语言：shell；完整代码见附录第 \pageref{code:24:1} 页，共 3 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.24.3}
语言：shell；完整代码见附录第 \pageref{code:24:3} 页，共 2 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:24:4} 页，共 94 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.25.1}
语言：shell；完整代码见附录第 \pageref{code:25:1} 页，共 1 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.25.2}
语言：shell；完整代码见附录第 \pageref{code:25:2} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.25.3}
语言：shell；完整代码见附录第 \pageref{code:25:3} 页，共 4 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.25.4}
语言：shell；完整代码见附录第 \pageref{code:25:4} 页，共 2 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:25:5} 页，共 20 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:25:6} 页，共 10 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.26.1}
语言：shell；完整代码见附录第 \pageref{code:26:1} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.26.2}
语言：shell；完整代码见附录第 \pageref{code:26:2} 页，共 1 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:26:3} 页，共 25 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:26:4} 页，共 14 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:26:5} 页，共 31 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:26:6} 页，共 72 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.26.7}
语言：shell；完整代码见附录第 \pageref{code:26:7} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.26.8}
语言：shell；完整代码见附录第 \pageref{code:26:8} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.28.1}
语言：shell；完整代码见附录第 \pageref{code:28:1} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.28.2}
语言：shell；完整代码见附录第 \pageref{code:28:2} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.28.3}
语言：shell；完整代码见附录第 \pageref{code:28:3} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.28.4}
语言：shell；完整代码见附录第 \pageref{code:28:4} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.28.5}
语言：shell；完整代码见附录第 \pageref{code:28:5} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.28.6}
语言：shell；完整代码见附录第 \pageref{code:28:6} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.28.7}
语言：shell；完整代码见附录第 \pageref{code:28:7} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.28.8}
语言：shell；完整代码见附录第 \pageref{code:28:8} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.28.9}
语言：shell；完整代码见附录第 \pageref{code:28:9} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.28.10}
语言：shell；完整代码见附录第 \pageref{code:28:10} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.28.11}
语言：shell；完整代码见附录第 \pageref{code:28:11} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.28.12}
语言：shell；完整代码见附录第 \pageref{code:28:12} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.29.1}
语言：shell；完整代码见附录第 \pageref{code:29:1} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.29.2}
语言：shell；完整代码见附录第 \pageref{code:29:2} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.29.3}
语言：shell；完整代码见附录第 \pageref{code:29:3} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.29.4}
语言：shell；完整代码见附录第 \pageref{code:29:4} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.29.5}
语言：shell；完整代码见附录第 \pageref{code:29:5} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.29.6}
语言：shell；完整代码见附录第 \pageref{code:29:6} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.29.7}
语言：shell；完整代码见附录第 \pageref{code:29:7} 页，共 2 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.29.8}
语言：shell；完整代码见附录第 \pageref{code:29:8} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.29.9}
语言：shell；完整代码见附录第 \pageref{code:29:9} 页，共 2 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:30:1} 页，共 3 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:30:2} 页，共 14 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:30:3} 页，共 2 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.30.4}
语言：python；完整代码见附录第 \pageref{code:30:4} 页，共 2 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.30.5}
语言：python；完整代码见附录第 \pageref{code:30:5} 页，共 2 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.30.6}
语言：python；完整代码见附录第 \pageref{code:30:6} 页，共 41 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:30:8} 页，共 2 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:30:9} 页，共 14 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.30.10}
语言：python；完整代码见附录第 \pageref{code:30:10} 页，共 5 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:30:11} 页，共 8 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.30.12}
语言：python；完整代码见附录第 \pageref{code:30:12} 页，共 5 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:30:13} 页，共 8 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:30:14} 页，共 5 行。
\end{codeindexbox}
...
TBModel.set\_\allowbreak{}parameters方法会将符号化的提供方(字符串或可调用对象)替换为您指定的数值。调用此方法后,这些项将变为永久固定的数值。\par
...
语言：python；完整代码见附录第 \pageref{code:30:15} 页，共 3 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.30.16}
语言：python；完整代码见附录第 \pageref{code:30:16} 页，共 2 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.30.17}
语言：python；完整代码见附录第 \pageref{code:30:17} 页，共 43 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.30.18}
语言：python；完整代码见附录第 \pageref{code:30:18} 页，共 4 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.30.19}
语言：python；完整代码见附录第 \pageref{code:30:19} 页，共 3 行。
\end{codeindexbox}


如果您不希望修改原始模型,可以使用 TBModel.with\_\allowbreak{}parameters方法。此方法会返回一个指定参数已被冻结的副本。\par


\begin{codeindexbox}{代码清单 A.30.20}
语言：python；完整代码见附录第 \pageref{code:30:20} 页，共 18 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.30.21}
语言：python；完整代码见附录第 \pageref{code:30:21} 页，共 4 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:30:22} 页，共 11 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.30.23}
语言：python；完整代码见附录第 \pageref{code:30:23} 页，共 39 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:30:24} 页，共 4 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:30:25} 页，共 39 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:30:26} 页，共 3 行。
\end{codeindexbox}
...
PythTB是一款用于构建和分析紧束缚模型的Python库,专为现代拓扑能带论应用而设计。它提供了从模型设定到物理解释的高效路径,既适用于电子结构的学习,也可用于研究级别的计算。只需几行代码,您就 能定义晶格模型、构建紧束缚哈密顿量并计算电子性质。\par
...
\begin{codeindexbox}{代码清单 A.31.1}
语言：shell；完整代码见附录第 \pageref{code:31:1} 页，共 2 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:31:2} 页，共 3 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.31.3}
语言：python；完整代码见附录第 \pageref{code:31:3} 页，共 3 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.31.4}
语言：python；完整代码见附录第 \pageref{code:31:4} 页，共 2 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:31:5} 页，共 27 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:31:6} 页，共 2 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.31.7}
语言：python；完整代码见附录第 \pageref{code:31:7} 页，共 3 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:31:8} 页，共 3 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.31.9}
语言：python；完整代码见附录第 \pageref{code:31:9} 页，共 5 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.31.10}
语言：python；完整代码见附录第 \pageref{code:31:10} 页，共 3 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.31.11}
语言：python；完整代码见附录第 \pageref{code:31:11} 页，共 3 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:31:12} 页，共 2 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.31.13}
语言：python；完整代码见附录第 \pageref{code:31:13} 页，共 2 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:31:14} 页，共 91 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:32:1} 页，共 3 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:32:2} 页，共 6 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:32:3} 页，共 4 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:32:4} 页，共 13 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:32:5} 页，共 2 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.32.6}
语言：python；完整代码见附录第 \pageref{code:32:6} 页，共 10 行。
\end{codeindexbox}
...
您可以通过调用 loop方法来声明一个轴对布里渊区进行卷绕。该方法接受以下参数:\par
...
调用完成后,您会看到网格信息现在会显示这两个轴都在卷绕布里渊区。\par
...
语言：python；完整代码见附录第 \pageref{code:32:7} 页，共 7 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.32.8}
语言：python；完整代码见附录第 \pageref{code:32:8} 页，共 10 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:32:9} 页，共 8 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.32.10}
语言：python；完整代码见附录第 \pageref{code:32:10} 页，共 10 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:33:1} 页，共 3 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:33:2} 页，共 7 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.33.3}
语言：python；完整代码见附录第 \pageref{code:33:3} 页，共 5 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.33.4}
语言：python；完整代码见附录第 \pageref{code:33:4} 页，共 15 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:33:5} 页，共 4 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:33:6} 页，共 8 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.33.7}
语言：python；完整代码见附录第 \pageref{code:33:7} 页，共 2 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:33:8} 页，共 53 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:33:9} 页，共 3 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:33:10} 页，共 4 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.33.11}
语言：python；完整代码见附录第 \pageref{code:33:11} 页，共 6 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.33.12}
语言：python；完整代码见附录第 \pageref{code:33:12} 页，共 8 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:33:13} 页，共 18 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.33.14}
语言：python；完整代码见附录第 \pageref{code:33:14} 页，共 5 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:33:15} 页，共 4 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:33:16} 页，共 3 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:33:17} 页，共 32 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.33.18}
语言：python；完整代码见附录第 \pageref{code:33:18} 页，共 53 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.33.19}
语言：python；完整代码见附录第 \pageref{code:33:19} 页，共 5 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:34:1} 页，共 6 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.34.2}
语言：python；完整代码见附录第 \pageref{code:34:2} 页，共 4 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.34.3}
语言：python；完整代码见附录第 \pageref{code:34:3} 页，共 2 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:34:4} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.34.5}
语言：python；完整代码见附录第 \pageref{code:34:5} 页，共 2 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:34:6} 页，共 19 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.34.7}
语言：python；完整代码见附录第 \pageref{code:34:7} 页，共 3 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:34:8} 页，共 2 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.34.9}
语言：python；完整代码见附录第 \pageref{code:34:9} 页，共 7 行。
\end{codeindexbox}
...
请回忆 Mesh 教程中的内容:我们需要根据在函数中变化的参数名称来命名这个坐标轴(如果您错过了,可以参阅上面的函数说明)。\par


λ TBModel1\par


\begin{codeindexbox}{代码清单 A.34.10}
语言：python；完整代码见附录第 \pageref{code:34:10} 页，共 2 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:34:11} 页，共 8 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:34:12} 页，共 5 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.34.13}
语言：python；完整代码见附录第 \pageref{code:34:13} 页，共 11 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.34.14}
语言：python；完整代码见附录第 \pageref{code:34:14} 页，共 2 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:34:15} 页，共 2 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:34:16} 页，共 2 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.34.17}
语言：python；完整代码见附录第 \pageref{code:34:17} 页，共 2 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:35:1} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.35.2}
语言：python；完整代码见附录第 \pageref{code:35:2} 页，共 3 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:36:1} 页，共 2 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:36:2} 页，共 2 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:37:1} 页，共 2 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:37:2} 页，共 2 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:38:2} 页，共 8 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.38.3}
语言：shell；完整代码见附录第 \pageref{code:38:3} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.38.4}
语言：shell；完整代码见附录第 \pageref{code:38:4} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.38.5}
语言：shell；完整代码见附录第 \pageref{code:38:5} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.38.6}
语言：shell；完整代码见附录第 \pageref{code:38:6} 页，共 3 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.39.1}
语言：shell；完整代码见附录第 \pageref{code:39:1} 页，共 1 行。
\end{codeindexbox}
...
\begin{partbox}本专题收录 8 篇文章。\end{partbox}
...
语言：text；完整代码见附录第 \pageref{code:40:5} 页，共 227 行。
\end{codeindexbox}
...
语言：text；完整代码见附录第 \pageref{code:40:6} 页，共 5 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.41.4}
语言：text；完整代码见附录第 \pageref{code:41:4} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.42.18}
语言：text；完整代码见附录第 \pageref{code:42:18} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.43.1}
语言：bat；完整代码见附录第 \pageref{code:43:1} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.43.5}
语言：bat；完整代码见附录第 \pageref{code:43:5} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.43.6}
语言：bat；完整代码见附录第 \pageref{code:43:6} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.43.7}
语言：bat；完整代码见附录第 \pageref{code:43:7} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.43.8}
语言：bat；完整代码见附录第 \pageref{code:43:8} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.43.9}
语言：bat；完整代码见附录第 \pageref{code:43:9} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.43.11}
语言：bat；完整代码见附录第 \pageref{code:43:11} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.43.12}
语言：bat；完整代码见附录第 \pageref{code:43:12} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.43.17}
语言：bat；完整代码见附录第 \pageref{code:43:17} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.43.18}
语言：bat；完整代码见附录第 \pageref{code:43:18} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.43.19}
语言：bat；完整代码见附录第 \pageref{code:43:19} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.43.20}
语言：bat；完整代码见附录第 \pageref{code:43:20} 页，共 4 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.43.21}
语言：bat；完整代码见附录第 \pageref{code:43:21} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.43.22}
语言：bat；完整代码见附录第 \pageref{code:43:22} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.43.23}
语言：bat；完整代码见附录第 \pageref{code:43:23} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.43.24}
语言：bat；完整代码见附录第 \pageref{code:43:24} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.43.25}
语言：bat；完整代码见附录第 \pageref{code:43:25} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.43.26}
语言：bat；完整代码见附录第 \pageref{code:43:26} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.43.28}
语言：bat；完整代码见附录第 \pageref{code:43:28} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.43.29}
语言：bat；完整代码见附录第 \pageref{code:43:29} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.43.34}
语言：bat；完整代码见附录第 \pageref{code:43:34} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.43.35}
语言：bat；完整代码见附录第 \pageref{code:43:35} 页，共 4 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.43.36}
语言：bat；完整代码见附录第 \pageref{code:43:36} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.43.37}
语言：bat；完整代码见附录第 \pageref{code:43:37} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.43.38}
语言：bat；完整代码见附录第 \pageref{code:43:38} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.43.39}
语言：bat；完整代码见附录第 \pageref{code:43:39} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.43.41}
语言：bat；完整代码见附录第 \pageref{code:43:41} 页，共 1 行。
\end{codeindexbox}
...
如果你也在用 Jekyll、GitHub Pages 或类似的静态博客,这篇内容基本可以直接参考。\par
...
\begin{codeindexbox}{代码清单 A.45.3}
语言：javascript；完整代码见附录第 \pageref{code:45:3} 页，共 1 行。
\end{codeindexbox}
...
\section{(原创教程)使用Latex排版申博申请材料}
\begin{articlemeta}
\textbf{日期：}2026-07-06\hfill\textbf{在线原文：}\href{https://marx2001.github.io/sci-note\_posts/20260706-phd-portfolio-workflow}{marx2001.github.io}
\end{articlemeta}

\subsubsection{说明}


本文用于记录我的\textbf{申博补充材料 PDF 自动化工作流}。这个工作流的目标是:将个人网页 \texttt{\_\allowbreak{}posts} 文件夹中的 Markdown 内容,自动筛选、转换、排版,并生成一个可以和简历一起发送的正式 PDF 文档。\par


这个 PDF 不是网页截图,也不是简单的 Markdown 合并文件,而是一个面向申博使用的 \textbf{Research Portfolio /\allowbreak{} Supplementary Academic Portfolio}。它可以把研究笔记、原创脚本、代表性结果图、计算流程、项目记录等内容整理成一个正式的 PDF 附件。\par
...
\begin{itemize}
\item 直接读取个人网页 \texttt{\_\allowbreak{}posts} 文件夹中的 Markdown 文件;
\item 只筛选 \texttt{sci-note} 分类下的文章;
\item 用 \texttt{pdf\_\allowbreak{}order.txt} 控制哪些文章进入 PDF 以及文章顺序;
\item 自动复制图片到纯英文路径,避免中文图片路径导致 LaTeX 编译失败;
\item 自动压缩正文中过长的代码块;
\item 完整代码自动收集到 PDF 最后的 Appendix;
\item 支持单篇 Markdown 预览;
\item 支持完整 PDF 构建;
\item 支持强制全量重建;
\item 支持 \textbf{PDF 专用 LaTeX 手动编辑层},可以手动调整最终 PDF 中每篇文章的 \texttt{.tex} 排版。
\end{itemize}
...
语言：text；完整代码见附录第 \pageref{code:46:1} 页，共 22 行。
\end{codeindexbox}
...
语言：text；完整代码见附录第 \pageref{code:46:2} 页，共 1 行。
\end{codeindexbox}


这个文件就是可以和简历一起发送的申博补充材料 PDF。\par
...
我的申博 PDF 项目目录大致如下:\par


\begin{codeindexbox}{代码清单 A.46.3}
语言：text；完整代码见附录第 \pageref{code:46:3} 页，共 18 行。
\end{codeindexbox}
...
语言：text；完整代码见附录第 \pageref{code:46:4} 页，共 4 行。
\end{codeindexbox}
...
语言：text；完整代码见附录第 \pageref{code:46:5} 页，共 6 行。
\end{codeindexbox}


这些自动生成的文件一般不需要手动修改。尤其注意:\par
...
是 Pandoc 自动生成的中间文件,不建议手动修改,因为重新构建时可能被覆盖。需要手动调整 PDF 版式时,应修改:\par
...
\subsubsection{PDF 专用 LaTeX 手动编辑层}


新增的 \texttt{pdf\_\allowbreak{}tex\_\allowbreak{}edits/\allowbreak{}} 文件夹用于解决一个关键问题:\par


\begin{codeindexbox}{代码清单 A.46.8}
语言：text；完整代码见附录第 \pageref{code:46:8} 页，共 2 行。
\end{codeindexbox}
...
语言：text；完整代码见附录第 \pageref{code:46:9} 页，共 2 行。
\end{codeindexbox}
...
语言：text；完整代码见附录第 \pageref{code:46:10} 页，共 2 行。
\end{codeindexbox}
...
语言：text；完整代码见附录第 \pageref{code:46:11} 页，共 2 行。
\end{codeindexbox}


如果 \texttt{pdf\_\allowbreak{}tex\_\allowbreak{}edits/\allowbreak{}2026-2-5\_\allowbreak{}471929fc.tex} 存在,最终 PDF 就会使用它,而不是 \texttt{converted/\allowbreak{}2026-2-5\_\allowbreak{}471929fc.tex}。\par


\medskip\hrule\medskip


\subsubsection{第一次生成可手动编辑的 tex 文件}


不需要额外命令。正常运行构建命令即可:\par


\begin{codeindexbox}{代码清单 A.46.12}
语言：powershell；完整代码见附录第 \pageref{code:46:12} 页，共 1 行。
\end{codeindexbox}
...
语言：powershell；完整代码见附录第 \pageref{code:46:13} 页，共 1 行。
\end{codeindexbox}
...
如果 \texttt{pdf\_\allowbreak{}tex\_\allowbreak{}edits/\allowbreak{}} 中没有同名文件,就会自动复制一份。之后你就可以打开 \texttt{pdf\_\allowbreak{}tex\_\allowbreak{}edits/\allowbreak{}} 中对应的 \texttt{.tex} 文件进行手动排版。\par
...
语言：text；完整代码见附录第 \pageref{code:46:17} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.46.18}
语言：text；完整代码见附录第 \pageref{code:46:18} 页，共 1 行。
\end{codeindexbox}
...
\subsubsection{如何确认 PDF 使用的是手动 tex 文件}
...
语言：tex；完整代码见附录第 \pageref{code:46:20} 页，共 1 行。
\end{codeindexbox}


说明最终 PDF 已经使用手动编辑层。\par
...
语言：tex；完整代码见附录第 \pageref{code:46:21} 页，共 1 行。
\end{codeindexbox}


说明对应的手动 \texttt{.tex} 文件还没有生成,或者文件没有放在正确位置。\par


\medskip\hrule\medskip


\subsubsection{手动修改 tex 后如何重新生成 PDF}
...
之后,不需要加 \texttt{--force},直接运行:\par


\begin{codeindexbox}{代码清单 A.46.23}
语言：powershell；完整代码见附录第 \pageref{code:46:23} 页，共 1 行。
\end{codeindexbox}
...
语言：powershell；完整代码见附录第 \pageref{code:46:24} 页，共 1 行。
\end{codeindexbox}
...
\texttt{--force} 主要用于重新清理缓存和自动生成文件。如果只是修改 \texttt{pdf\_\allowbreak{}tex\_\allowbreak{}edits/\allowbreak{}*.tex},一般不需要 \texttt{--force}。\par


\medskip\hrule\medskip


\subsubsection{什么时候改 Markdown,什么时候改 tex}
...
语言：text；完整代码见附录第 \pageref{code:46:25} 页，共 14 行。
\end{codeindexbox}
...
语言：text；完整代码见附录第 \pageref{code:46:26} 页，共 2 行。
\end{codeindexbox}
...
\subsubsection{适合在 pdf\_\allowbreak{}tex\_\allowbreak{}edits 中手动调整的内容}


\texttt{pdf\_\allowbreak{}tex\_\allowbreak{}edits/\allowbreak{}*.tex} 适合处理 Markdown 自动转换后不够美观的局部排版问题,例如:\par


\begin{itemize}
\item 修改标题层级;
\item 删除不适合 PDF 的网页内容;
\item 调整图片大小;
\item 把普通图片改成标准 \texttt{figure} 环境;
\item 调整图片前后空白;
\item 手动加入 \texttt{\textbackslash{}\allowbreak{}clearpage};
\item 调整表格宽度;
\item 压缩代码块字号;
\item 删除正文中冗长的代码预览;
\item 优化单篇文章的说明结构。
...
例如,Pandoc 有时会把网页中的标题转换得不够理想,如果出现类似:\par


\begin{codeindexbox}{代码清单 A.46.27}
语言：tex；完整代码见附录第 \pageref{code:46:27} 页，共 3 行。
\end{codeindexbox}
...
语言：tex；完整代码见附录第 \pageref{code:46:28} 页，共 1 行。
\end{codeindexbox}
...
语言：tex；完整代码见附录第 \pageref{code:46:29} 页，共 6 行。
\end{codeindexbox}


如果还嫌大,可以把 \texttt{\textbackslash{}\allowbreak{}small} 换成:\par


\begin{codeindexbox}{代码清单 A.46.30}
语言：tex；完整代码见附录第 \pageref{code:46:30} 页，共 1 行。
\end{codeindexbox}
...
语言：tex；完整代码见附录第 \pageref{code:46:31} 页，共 1 行。
\end{codeindexbox}
...
\subsubsection{如何重新生成某个手动 tex 初稿}


如果你已经手动修改过某个 \texttt{pdf\_\allowbreak{}tex\_\allowbreak{}edits/\allowbreak{}*.tex},脚本默认不会覆盖它。\par


如果想放弃手动修改,重新从 Pandoc 自动转换结果开始排版,可以删除对应文件:\par


\begin{codeindexbox}{代码清单 A.46.32}
语言：text；完整代码见附录第 \pageref{code:46:32} 页，共 1 行。
\end{codeindexbox}
...
语言：powershell；完整代码见附录第 \pageref{code:46:33} 页，共 1 行。
\end{codeindexbox}
...
语言：text；完整代码见附录第 \pageref{code:46:34} 页，共 1 行。
\end{codeindexbox}
...
\subsubsection{个人网页 Markdown 文件位置}
...
语言：text；完整代码见附录第 \pageref{code:46:36} 页，共 1 行。
\end{codeindexbox}
...
由于 \texttt{img} 文件夹内部存在中文命名的子文件夹,LaTeX 直接读取这些路径时可能不稳定。因此,\texttt{build.py} 会自动将被引用的图片复制到:\par
...
这样可以避免中文路径导致的编译问题。\par


\medskip\hrule\medskip


\subsubsection{Markdown 文件的 front matter 要求}


想被纳入 PDF 的 Markdown 文件,必须属于 \texttt{sci-note} 分类。推荐 front matter 写法如下:\par


\begin{codeindexbox}{代码清单 A.46.40}
语言：yaml；完整代码见附录第 \pageref{code:46:40} 页，共 8 行。
\end{codeindexbox}
...
语言：yaml；完整代码见附录第 \pageref{code:46:41} 页，共 1 行。
\end{codeindexbox}


如果一个 Markdown 文件没有这个分类,即使它在 \texttt{\_\allowbreak{}posts} 文件夹中,也不会被纳入申博 PDF 的候选范围。\par


\medskip\hrule\medskip


\subsubsection{pdf\_\allowbreak{}order.txt 的作用}


\texttt{pdf\_\allowbreak{}order.txt} 用来控制:\par


\begin{enumerate}
\item 哪些 Markdown 文件进入最终 PDF;
\item 这些 Markdown 文件在 PDF 中的排列顺序。
\end{enumerate}
...
语言：text；完整代码见附录第 \pageref{code:46:42} 页，共 7 行。
\end{codeindexbox}


注意,这里写的是 \texttt{\_\allowbreak{}posts} 文件夹中的\textbf{原始 Markdown 文件名},不是转换后的 \texttt{.tex} 文件名。\par
...
\subsubsection{第一步:找到需要加入 PDF 的 Markdown 文件}


首先在个人网页 \texttt{\_\allowbreak{}posts} 文件夹中找到目标文件,例如:\par
...
确认它的 front matter 中有:\par


\begin{codeindexbox}{代码清单 A.46.44}
语言：yaml；完整代码见附录第 \pageref{code:46:44} 页，共 1 行。
\end{codeindexbox}
...
\subsubsection{第二步:把文件名加入 pdf\_\allowbreak{}order.txt}


打开 \texttt{pdf\_\allowbreak{}order.txt},新增一行:\par
...
如果想调整 PDF 中的章节顺序,只需要调整 \texttt{pdf\_\allowbreak{}order.txt} 中各行文件名的顺序。\par


\medskip\hrule\medskip


\subsubsection{第三步:预览单篇文章}


如果只是想检查新加入的这篇文章在 PDF 中的效果,可以运行:\par


\begin{codeindexbox}{代码清单 A.46.46}
语言：powershell；完整代码见附录第 \pageref{code:46:46} 页，共 1 行。
\end{codeindexbox}
...
语言：powershell；完整代码见附录第 \pageref{code:46:47} 页，共 1 行。
\end{codeindexbox}
...
语言：text；完整代码见附录第 \pageref{code:46:48} 页，共 1 行。
\end{codeindexbox}


预览 PDF 只包含匹配到的 Markdown 文件,适合快速检查单篇内容、图片和代码压缩效果。\par


第一次预览时,脚本也会自动生成对应的:\par
...
\subsubsection{第四步:手动调整 PDF 版式}


如果预览 PDF 中存在标题、图片、代码块、分页、空白等问题,就打开对应的:\par
...
\begin{codeindexbox}{代码清单 A.46.51}
语言：powershell；完整代码见附录第 \pageref{code:46:51} 页，共 1 行。
\end{codeindexbox}


不需要加 \texttt{--force}。\par


\medskip\hrule\medskip


\subsubsection{第五步:生成最终完整 PDF}
...
语言：powershell；完整代码见附录第 \pageref{code:46:52} 页，共 1 行。
\end{codeindexbox}


这会根据 \texttt{pdf\_\allowbreak{}order.txt} 生成完整 PDF:\par
...
这个 PDF 才是最终的申博补充材料版本。\par


\medskip\hrule\medskip


\subsubsection{第六步:必要时强制全量重建}
...
语言：powershell；完整代码见附录第 \pageref{code:46:54} 页，共 1 行。
\end{codeindexbox}


这个命令会清理缓存和自动生成文件,并重新构建所有内容。\par


注意:\texttt{--force} 不会删除 \texttt{pdf\_\allowbreak{}tex\_\allowbreak{}edits/\allowbreak{}} 中已经存在的手动 \texttt{.tex} 文件,因此已经完成的手动排版调整不会被误删。\par


\medskip\hrule\medskip


\subsubsection{常用命令总结}
...
目的 & 命令 & 输出 \\
\midrule
预览单篇 Markdown & python build.py --only 关键词 & Ruixiao\_\allowbreak{}Ma\_\allowbreak{}Research\_\allowbreak{}Portfolio\_\allowbreak{}PREVIEW.pdf \\
生成完整 PDF & python build.py & Ruixiao\_\allowbreak{}Ma\_\allowbreak{}Research\_\allowbreak{}Portfolio.pdf \\
...
语言：powershell；完整代码见附录第 \pageref{code:46:55} 页，共 1 行。
\end{codeindexbox}
...
语言：powershell；完整代码见附录第 \pageref{code:46:57} 页，共 1 行。
\end{codeindexbox}


才会根据 \texttt{pdf\_\allowbreak{}order.txt} 生成完整总 PDF,输出文件是:\par
...
\begin{codeindexbox}{代码清单 A.46.59}
语言：text；完整代码见附录第 \pageref{code:46:59} 页，共 13 行。
\end{codeindexbox}
...
\subsubsection{长代码块的处理规则}


为了避免完整代码严重影响正文阅读,当前工作流会自动处理长代码块。\par


规则如下:\par


\begin{codeindexbox}{代码清单 A.46.60}
语言：text；完整代码见附录第 \pageref{code:46:60} 页，共 3 行。
\end{codeindexbox}
...
语言：text；完整代码见附录第 \pageref{code:46:61} 页，共 4 行。
\end{codeindexbox}


完整代码会出现在 PDF 最后的:\par
...
\begin{enumerate}
\item 正文保持可读性;
\item 完整代码仍然保留在 PDF 中。
\end{enumerate}


如果正文中的代码预览仍然太长,可以在 \texttt{pdf\_\allowbreak{}tex\_\allowbreak{}edits/\allowbreak{}*.tex} 中手动删除或压缩正文预览,同时保留 Appendix 中的完整代码。\par


\medskip\hrule\medskip


\subsubsection{图片处理规则}
...
语言：markdown；完整代码见附录第 \pageref{code:46:63} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.46.64}
语言：markdown；完整代码见附录第 \pageref{code:46:64} 页，共 1 行。
\end{codeindexbox}


\texttt{build.py} 会自动:\par


\begin{enumerate}
\item 识别图片路径;
\item 在原始 \texttt{img} 文件夹中找到图片;
\item 复制到 \texttt{\_\allowbreak{}pdf\_\allowbreak{}images/\allowbreak{}};
\item 重命名为纯英文文件名;
\item 将 Markdown 中的图片路径改写为新路径。
\end{enumerate}
...
\begin{codeindexbox}{代码清单 A.46.65}
语言：text；完整代码见附录第 \pageref{code:46:65} 页，共 1 行。
\end{codeindexbox}
...
语言：text；完整代码见附录第 \pageref{code:46:66} 页，共 1 行。
\end{codeindexbox}


这样可以保证 LaTeX 编译时不直接处理中文图片路径。\par


如果想手动调整 PDF 中图片大小,可以在 \texttt{pdf\_\allowbreak{}tex\_\allowbreak{}edits/\allowbreak{}*.tex} 中修改,例如:\par


\begin{codeindexbox}{代码清单 A.46.67}
语言：tex；完整代码见附录第 \pageref{code:46:67} 页，共 1 行。
\end{codeindexbox}
...
\subsubsection{VS Code 中的使用方式}


在 VS Code 中,推荐打开整个申博 PDF 项目文件夹,而不是单独打开 \texttt{main.tex}。\par
...
语言：text；完整代码见附录第 \pageref{code:46:68} 页，共 1 行。
\end{codeindexbox}


然后使用 VS Code 内置终端运行命令:\par


\begin{codeindexbox}{代码清单 A.46.69}
语言：powershell；完整代码见附录第 \pageref{code:46:69} 页，共 1 行。
\end{codeindexbox}


如果配置了 \texttt{.vscode/\allowbreak{}tasks.json},也可以使用:\par


\begin{codeindexbox}{代码清单 A.46.70}
语言：text；完整代码见附录第 \pageref{code:46:70} 页，共 1 行。
\end{codeindexbox}
...
注意:这个工作流不建议直接点击 LaTeX Workshop 的 Build,因为 LaTeX Workshop 只会编译 \texttt{main.tex},不会先执行 Markdown 清洗、图片复制、Pandoc 转换以及 \texttt{pdf\_\allowbreak{}tex\_\allowbreak{}edits/\allowbreak{}} 手动层选择。\par
...
\subsubsection{问题 1:新 Markdown 文件没有进入 PDF}
...
\begin{enumerate}
\item 该文件是否在 \texttt{\_\allowbreak{}posts} 文件夹中;
\item front matter 是否有 \texttt{categories: sci-note};
\item 文件名是否已经加入 \texttt{pdf\_\allowbreak{}order.txt}。
\end{enumerate}
...
语言：powershell；完整代码见附录第 \pageref{code:46:71} 页，共 1 行。
\end{codeindexbox}


却没有选中文件,通常是因为该文件还没有加入 \texttt{pdf\_\allowbreak{}order.txt}。\par


当前逻辑下,如果存在 \texttt{pdf\_\allowbreak{}order.txt},\texttt{--only} 会在 \texttt{pdf\_\allowbreak{}order.txt} 已列出的文件中查找。因此标准做法是:\par


\begin{codeindexbox}{代码清单 A.46.72}
语言：text；完整代码见附录第 \pageref{code:46:72} 页，共 2 行。
\end{codeindexbox}
...
\subsubsection{问题 3:pdf\_\allowbreak{}tex\_\allowbreak{}edits 中没有对应 tex 文件}


先运行一次:\par


\begin{codeindexbox}{代码清单 A.46.73}
语言：powershell；完整代码见附录第 \pageref{code:46:73} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.46.74}
语言：powershell；完整代码见附录第 \pageref{code:46:74} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.46.75}
语言：text；完整代码见附录第 \pageref{code:46:75} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.46.76}
语言：text；完整代码见附录第 \pageref{code:46:76} 页，共 1 行。
\end{codeindexbox}


查看是否已经输入了 \texttt{pdf\_\allowbreak{}tex\_\allowbreak{}edits/\allowbreak{}*.tex}。正常情况下应类似:\par


\begin{codeindexbox}{代码清单 A.46.77}
语言：tex；完整代码见附录第 \pageref{code:46:77} 页，共 1 行。
\end{codeindexbox}
...
\subsubsection{问题 4:修改了 pdf\_\allowbreak{}tex\_\allowbreak{}edits 但 PDF 没变化}


检查:\par


\begin{codeindexbox}{代码清单 A.46.78}
语言：text；完整代码见附录第 \pageref{code:46:78} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.46.79}
语言：tex；完整代码见附录第 \pageref{code:46:79} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.46.80}
语言：tex；完整代码见附录第 \pageref{code:46:80} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.46.81}
语言：text；完整代码见附录第 \pageref{code:46:81} 页，共 1 行。
\end{codeindexbox}


而不是下载目录或其他位置的同名文件。\par


\medskip\hrule\medskip


\subsubsection{问题 5:图片找不到}


检查 Markdown 中图片路径是否确实指向个人网页的 \texttt{img} 文件夹。\par


常见可识别写法包括:\par


\begin{codeindexbox}{代码清单 A.46.82}
语言：markdown；完整代码见附录第 \pageref{code:46:82} 页，共 1 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.46.83}
语言：markdown；完整代码见附录第 \pageref{code:46:83} 页，共 1 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.46.84}
语言：html；完整代码见附录第 \pageref{code:46:84} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.46.85}
语言：markdown；完整代码见附录第 \pageref{code:46:85} 页，共 1 行。
\end{codeindexbox}


脚本会在 \texttt{SOURCE\_\allowbreak{}IMG\_\allowbreak{}DIR} 中递归搜索该文件名。\par


\medskip\hrule\medskip


\subsubsection{问题 6:修改了图片但 PDF 没更新}


如果只是替换了图片,但 Markdown 文件没有变化,缓存可能不会重新处理该文件。\par


解决方法:\par


\begin{codeindexbox}{代码清单 A.46.86}
语言：powershell；完整代码见附录第 \pageref{code:46:86} 页，共 1 行。
\end{codeindexbox}


或者轻微修改并保存对应 Markdown 文件,然后重新运行:\par


\begin{codeindexbox}{代码清单 A.46.87}
语言：powershell；完整代码见附录第 \pageref{code:46:87} 页，共 1 行。
\end{codeindexbox}
...
\subsubsection{问题 7:LaTeX 编译出现代码高亮相关报错}


如果出现类似:\par


\begin{codeindexbox}{代码清单 A.46.88}
语言：text；完整代码见附录第 \pageref{code:46:88} 页，共 3 行。
\end{codeindexbox}


说明旧的 converted 文件或 Pandoc 高亮命令没有清理干净。\par


解决方法:\par


\begin{codeindexbox}{代码清单 A.46.89}
语言：powershell；完整代码见附录第 \pageref{code:46:89} 页，共 1 行。
\end{codeindexbox}


当前版本已经关闭 Pandoc 代码高亮,并在 \texttt{main.tex} 中加入了兼容定义。\par


\medskip\hrule\medskip


\subsubsection{最终发送前检查清单}
...
\begin{itemize}
\item 封面中的学校、邮箱、个人网站是否已经替换;
\item 目录是否完整且顺序合理;
\item 所有图片是否正常显示;
\item 正文中长代码是否已被合理压缩;
\item Appendix 中完整代码是否保留;
\item \texttt{pdf\_\allowbreak{}tex\_\allowbreak{}edits/\allowbreak{}*.tex} 中的手动排版是否已经生效;
\item \texttt{converted/\allowbreak{}includes.tex} 是否输入了正确的 \texttt{pdf\_\allowbreak{}tex\_\allowbreak{}edits/\allowbreak{}*.tex};
\item PDF 页码、页眉是否正常;
\item 是否存在明显的空标题、乱码或路径文本;
\item 文件名是否为 \texttt{Ruixiao\_\allowbreak{}Ma\_\allowbreak{}Research\_\allowbreak{}Portfolio.pdf};
\item PDF 是否可以独立打开,不依赖本地图片路径。
\end{itemize}
...
\subsubsection{推荐的日常使用顺序}


最常用的完整流程如下:\par


\begin{codeindexbox}{代码清单 A.46.90}
语言：text；完整代码见附录第 \pageref{code:46:90} 页，共 11 行。
\end{codeindexbox}
...
这个工作流适合长期维护。以后新增科研笔记、脚本说明、研究项目记录时,只需要维护个人网页中的 Markdown 文件和 \texttt{pdf\_\allowbreak{}order.txt};如果 PDF 自动排版效果不理想,再通过 \texttt{pdf\_\allowbreak{}tex\_\allowbreak{}edits/\allowbreak{}*.tex} 做局部修整即可。\par


本质上,这个流程实现了:\par


\begin{codeindexbox}{代码清单 A.46.91}
语言：text；完整代码见附录第 \pageref{code:46:91} 页，共 3 行。
\end{codeindexbox}


这样既能保证个人网页和申博补充材料之间保持一致,又能避免 PDF 被 Markdown 自动转换结果限制,从而兼顾自动化和最终排版质量。\par
...
语言：text；完整代码见附录第 \pageref{code:47:1} 页，共 1 行。
\end{codeindexbox}
...
语言：text；完整代码见附录第 \pageref{code:47:2} 页，共 11 行。
\end{codeindexbox}
...
语言：text；完整代码见附录第 \pageref{code:47:3} 页，共 2 行。
\end{codeindexbox}
...
语言：text；完整代码见附录第 \pageref{code:47:4} 页，共 1 行。
\end{codeindexbox}
...
语言：text；完整代码见附录第 \pageref{code:47:5} 页，共 4 行。
\end{codeindexbox}
...
语言：text；完整代码见附录第 \pageref{code:47:6} 页，共 1 行。
\end{codeindexbox}
...
语言：text；完整代码见附录第 \pageref{code:47:7} 页，共 1 行。
\end{codeindexbox}
...
语言：text；完整代码见附录第 \pageref{code:47:8} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.9}
语言：text；完整代码见附录第 \pageref{code:47:9} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.10}
语言：text；完整代码见附录第 \pageref{code:47:10} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.11}
语言：text；完整代码见附录第 \pageref{code:47:11} 页，共 1 行。
\end{codeindexbox}


你要进入的是可以设置 \textbf{space group /\allowbreak{} lattice parameters /\allowbreak{} asymmetric unit atoms} 的晶体构建窗口。\par
...
\begin{codeindexbox}{代码清单 A.47.12}
语言：text；完整代码见附录第 \pageref{code:47:12} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.13}
语言：text；完整代码见附录第 \pageref{code:47:13} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.14}
语言：text；完整代码见附录第 \pageref{code:47:14} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.15}
语言：text；完整代码见附录第 \pageref{code:47:15} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.16}
语言：text；完整代码见附录第 \pageref{code:47:16} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.17}
语言：text；完整代码见附录第 \pageref{code:47:17} 页，共 7 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.18}
语言：text；完整代码见附录第 \pageref{code:47:18} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.19}
语言：text；完整代码见附录第 \pageref{code:47:19} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.20}
语言：text；完整代码见附录第 \pageref{code:47:20} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.21}
语言：text；完整代码见附录第 \pageref{code:47:21} 页，共 3 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.22}
语言：text；完整代码见附录第 \pageref{code:47:22} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.23}
语言：text；完整代码见附录第 \pageref{code:47:23} 页，共 3 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.24}
语言：text；完整代码见附录第 \pageref{code:47:24} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.25}
语言：text；完整代码见附录第 \pageref{code:47:25} 页，共 8 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.26}
语言：text；完整代码见附录第 \pageref{code:47:26} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.27}
语言：text；完整代码见附录第 \pageref{code:47:27} 页，共 8 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.28}
语言：text；完整代码见附录第 \pageref{code:47:28} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.29}
语言：text；完整代码见附录第 \pageref{code:47:29} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.30}
语言：text；完整代码见附录第 \pageref{code:47:30} 页，共 8 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.31}
语言：text；完整代码见附录第 \pageref{code:47:31} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.32}
语言：text；完整代码见附录第 \pageref{code:47:32} 页，共 8 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.33}
语言：text；完整代码见附录第 \pageref{code:47:33} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.34}
语言：text；完整代码见附录第 \pageref{code:47:34} 页，共 8 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.35}
语言：text；完整代码见附录第 \pageref{code:47:35} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.36}
语言：text；完整代码见附录第 \pageref{code:47:36} 页，共 8 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.37}
语言：text；完整代码见附录第 \pageref{code:47:37} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.38}
语言：text；完整代码见附录第 \pageref{code:47:38} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.39}
语言：text；完整代码见附录第 \pageref{code:47:39} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.40}
语言：text；完整代码见附录第 \pageref{code:47:40} 页，共 1 行。
\end{codeindexbox}


不同版本按钮名称略有不同。你要找的是让软件根据当前空间群和非等价位点生成完整晶体结构的按钮。\par


如果主窗口中有类似选项:\par


\begin{codeindexbox}{代码清单 A.47.41}
语言：text；完整代码见附录第 \pageref{code:47:41} 页，共 2 行。
\end{codeindexbox}
...
因为你输入的是非等价原子位点,必须通过空间群 \textbf{P -6 2 m, No. 189} 自动展开,才能得到完整晶胞。\par
...
\begin{codeindexbox}{代码清单 A.47.42}
语言：text；完整代码见附录第 \pageref{code:47:42} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.43}
语言：text；完整代码见附录第 \pageref{code:47:43} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.44}
语言：text；完整代码见附录第 \pageref{code:47:44} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.45}
语言：text；完整代码见附录第 \pageref{code:47:45} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.46}
语言：text；完整代码见附录第 \pageref{code:47:46} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.47}
语言：text；完整代码见附录第 \pageref{code:47:47} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.48}
语言：text；完整代码见附录第 \pageref{code:47:48} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.49}
语言：text；完整代码见附录第 \pageref{code:47:49} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.50}
语言：text；完整代码见附录第 \pageref{code:47:50} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.51}
语言：text；完整代码见附录第 \pageref{code:47:51} 页，共 3 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.52}
语言：text；完整代码见附录第 \pageref{code:47:52} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.53}
语言：text；完整代码见附录第 \pageref{code:47:53} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.54}
语言：text；完整代码见附录第 \pageref{code:47:54} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.55}
语言：text；完整代码见附录第 \pageref{code:47:55} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.56}
语言：text；完整代码见附录第 \pageref{code:47:56} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.57}
语言：text；完整代码见附录第 \pageref{code:47:57} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.58}
语言：text；完整代码见附录第 \pageref{code:47:58} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.59}
语言：text；完整代码见附录第 \pageref{code:47:59} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.60}
语言：text；完整代码见附录第 \pageref{code:47:60} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.61}
语言：text；完整代码见附录第 \pageref{code:47:61} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.62}
语言：text；完整代码见附录第 \pageref{code:47:62} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.63}
语言：text；完整代码见附录第 \pageref{code:47:63} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.64}
语言：text；完整代码见附录第 \pageref{code:47:64} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.65}
语言：text；完整代码见附录第 \pageref{code:47:65} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.66}
语言：text；完整代码见附录第 \pageref{code:47:66} 页，共 3 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.67}
语言：text；完整代码见附录第 \pageref{code:47:67} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.68}
语言：text；完整代码见附录第 \pageref{code:47:68} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.69}
语言：text；完整代码见附录第 \pageref{code:47:69} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.70}
语言：text；完整代码见附录第 \pageref{code:47:70} 页，共 27 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.47.71}
语言：text；完整代码见附录第 \pageref{code:47:71} 页，共 7 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:48:1} 页，共 1175 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:48:2} 页，共 1450 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:48:3} 页，共 1008 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.48.4}
语言：python；完整代码见附录第 \pageref{code:48:4} 页，共 937 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.48.5}
语言：python；完整代码见附录第 \pageref{code:48:5} 页，共 1226 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.48.6}
语言：python；完整代码见附录第 \pageref{code:48:6} 页，共 874 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.48.7}
语言：python；完整代码见附录第 \pageref{code:48:7} 页，共 1058 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.48.8}
语言：python；完整代码见附录第 \pageref{code:48:8} 页，共 792 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:49:1} 页，共 2866 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:49:2} 页，共 886 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:49:3} 页，共 518 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:50:1} 页，共 1066 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:50:2} 页，共 1489 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:50:3} 页，共 1790 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:50:4} 页，共 1294 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:50:5} 页，共 1492 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:50:6} 页，共 1166 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:50:7} 页，共 1360 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:51:1} 页，共 1641 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:51:2} 页，共 1603 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:51:3} 页，共 1738 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:51:4} 页，共 1200 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:51:5} 页，共 1211 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:51:6} 页，共 901 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:51:7} 页，共 674 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:51:8} 页，共 819 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.52.1}
语言：python；完整代码见附录第 \pageref{code:52:1} 页，共 1892 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.52.2}
语言：python；完整代码见附录第 \pageref{code:52:2} 页，共 1984 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.52.3}
语言：python；完整代码见附录第 \pageref{code:52:3} 页，共 914 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.52.4}
语言：python；完整代码见附录第 \pageref{code:52:4} 页，共 420 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.52.5}
语言：python；完整代码见附录第 \pageref{code:52:5} 页，共 179 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.52.6}
语言：python；完整代码见附录第 \pageref{code:52:6} 页，共 301 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.52.7}
语言：python；完整代码见附录第 \pageref{code:52:7} 页，共 579 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.52.8}
语言：python；完整代码见附录第 \pageref{code:52:8} 页，共 230 行。
\end{codeindexbox}
...
\chapter{原创研究与机器学习}
\begin{partbox}本专题收录 17 篇文章。\end{partbox}

\section{堆叠诱导的II型量子自旋霍尔绝缘体在非传统磁性中的高自旋陈数}
\begin{articlemeta}
\textbf{日期：}2025-11-26\hfill\textbf{在线原文：}\href{https://marx2001.github.io/sci-note\_posts/20251126-lz}{marx2001.github.io}
\end{articlemeta}
...
通常,将两个单层的Type-I量子自旋霍尔绝缘体堆叠在一起会产生一个平庸绝缘体。然而,将两个Type-II量子自旋霍尔绝缘体堆叠后是否会得到平庸绝缘体,仍是一个尚未探索的问题。 在本研究中,基于晶格模型计算,我们证明堆叠两个Type-II量子自旋霍尔绝缘体不会产生平庸绝缘体,反而会形成一个具有高自旋陈数的量子自旋霍尔绝缘体。在该物相中,边界处共存着两对具有相反手性和自旋极化的拓扑边缘态。我们的计算进一步表明,双层体系的量子化自旋霍尔电导是单层体系的两倍。 当U(1)对称性存在时,高自旋陈数相保持稳定;当U(1)对称性破缺时,该物相在广泛的参数范围内依然存在。此外,基于第一性原理电子结构计算,我们提出双层Nb2SeTeO是一种具有高自旋陈数的Type-II量子自旋霍尔绝缘体。最后,将这一策略推广至多层堆叠体系,可自然实现具有更大自旋陈数的量子自旋霍尔绝缘体。 我们的工作不仅深化了对Type-I和Type-II量子自旋霍尔绝缘体之间区别的理解,也为实现高度量子化的自旋霍尔电导提供了一条新途径。\par
...
语言：plaintext；完整代码见附录第 \pageref{code:54:1} 页，共 3 行。
\end{codeindexbox}


\subsubsection{2. 研究背景}


传统量子自旋霍尔绝缘体在二维非磁性材料中实现,其受到时间反演对称性的保护。一个悬而未决的关键问题是:当时反演对称性被完全打破时,量子自旋霍尔效应是否依然可能存在?\par


尽管此前在反铁磁材料中有相关提案,但这些材料实际上仍保留了某种等效的联合对称性。本研究旨在探索在对称性更低的磁性系统中实现该效应的全新路径。\par


\subsubsection{3. 研究方法}


(1)对称性分析:从理论上论证,在d-wave阿尔特磁性材料中,动量空间不同方向的自旋劈裂方向相反,这为产生相反符号的陈数(Chern number)奠定了基础。\par


(2)第一性原理计算:寻找并验证真实的候选材料。研究聚焦于单层材料Nb2SeTeO。\par


首先确认了该材料的交错磁磁性基态、动力学和热稳定性。\par


计算表明,无自旋轨道耦合时,它是一种“双极化Weyl半金属”,为后续拓扑相变提供了理想起点。\par


加入自旋轨道耦合后,能带打开能隙,计算显示不同方向的Weyl点贡献了符号相反的Berry曲率和陈数,从而产生量子化的自旋霍尔电导,并直接计算出了具有相反手性的边缘态。\par


\par\begin{figure}[H]\centering
\includegraphics[max width=0.88\linewidth,max height=0.62\textheight,keepaspectratio]{assets/figure-22b3037a7912.png}
\end{figure}\par\par


(3)突破对称性限制:为了证明Type-II QSHI无需对称性保护,研究团队对Nb2SeTeO施加剪切应变,使其所有对称性(除平移对称性外)都被破坏,成为一种“Luttinger补偿磁性材料”。计算结果表明,即使在这种极端情况下,量子自旋霍尔效应依然存在。\par


\par\begin{figure}[H]\centering
\includegraphics[max width=0.88\linewidth,max height=0.62\textheight,keepaspectratio]{assets/figure-0e4433098aed.png}
\end{figure}\par\par


(4)紧束缚模型与拓扑相变:通过构建晶格模型,论文深入探讨了Type-II QSHI的稳定性条件。\par


发现只要体系存在U(1)对称性(自旋z分量守恒),该拓扑相就是稳定的。\par


当U(1)对称性被破坏,且自旋轨道耦合增强到一定程度时,Type-II QSHI会通过拓扑相变转变为一种“受阻原子绝缘体”相。\par


\par\begin{figure}[H]\centering
\includegraphics[max width=0.88\linewidth,max height=0.62\textheight,keepaspectratio]{assets/figure-73d5c4e6e956.png}
\end{figure}\par\par
...
A1:自旋陈数(Spin Chern Number)是量子自旋霍尔效应(QSHI)系统中拓扑不变量的表征方式之一,特别适用于描述不依赖时间反演对称性保护的系统,比如本文提到的type-II QSHI(第二类量子自旋霍尔绝缘体)。\par


\par\begin{figure}[H]\centering
\includegraphics[max width=0.88\linewidth,max height=0.62\textheight,keepaspectratio]{assets/figure-d85df303a6cf.png}
\end{figure}\par\par


\par\begin{figure}[H]\centering
\includegraphics[max width=0.88\linewidth,max height=0.62\textheight,keepaspectratio]{assets/figure-d71845275276.png}
\end{figure}\par\par


\par\begin{figure}[H]\centering
\includegraphics[max width=0.88\linewidth,max height=0.62\textheight,keepaspectratio]{assets/figure-7cfefad587d8.png}
\end{figure}\par\par


Q2:磁性不就是来源于时间反演对称性破缺吗?那么所有的磁性材料都不可能是z2拓扑绝缘体了吗?\par


A2: 
\par\begin{figure}[H]\centering
\includegraphics[max width=0.88\linewidth,max height=0.62\textheight,keepaspectratio]{assets/figure-50f4eb99e3b5.png}
\end{figure}\par\par


\par\begin{figure}[H]\centering
\includegraphics[max width=0.88\linewidth,max height=0.62\textheight,keepaspectratio]{assets/figure-19a5ae73edc6.png}
\end{figure}\par\par


\par\begin{figure}[H]\centering
\includegraphics[max width=0.88\linewidth,max height=0.62\textheight,keepaspectratio]{assets/figure-946f4d8bbf32.png}
\end{figure}\par\par


\par\begin{figure}[H]\centering
\includegraphics[max width=0.88\linewidth,max height=0.62\textheight,keepaspectratio]{assets/figure-ee4499005de1.png}
\end{figure}\par\par


\par\begin{figure}[H]\centering
\includegraphics[max width=0.88\linewidth,max height=0.62\textheight,keepaspectratio]{assets/figure-128a221a1b24.png}
\end{figure}\par\par


\par\begin{figure}[H]\centering
\includegraphics[max width=0.88\linewidth,max height=0.62\textheight,keepaspectratio]{assets/figure-0012e24dad68.png}
\end{figure}\par\par


\par\begin{figure}[H]\centering
\includegraphics[max width=0.88\linewidth,max height=0.62\textheight,keepaspectratio]{assets/figure-ceef1bb2cdef.png}
\end{figure}\par\par
...
\begin{codeindexbox}{代码清单 A.55.1}
语言：plaintext；完整代码见附录第 \pageref{code:55:1} 页，共 10 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.56.1}
语言：python；完整代码见附录第 \pageref{code:56:1} 页，共 24 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.56.2}
语言：python；完整代码见附录第 \pageref{code:56:2} 页，共 13 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.56.3}
语言：python；完整代码见附录第 \pageref{code:56:3} 页，共 20 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.56.4}
语言：python；完整代码见附录第 \pageref{code:56:4} 页，共 28 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.56.5}
语言：python；完整代码见附录第 \pageref{code:56:5} 页，共 103 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.56.6}
语言：python；完整代码见附录第 \pageref{code:56:6} 页，共 10 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.56.7}
语言：python；完整代码见附录第 \pageref{code:56:7} 页，共 10 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.56.8}
语言：python；完整代码见附录第 \pageref{code:56:8} 页，共 664 行。
\end{codeindexbox}
...
(1)第一步,把 Wannier 轨道“编号”跟“物理含义”一一对应起来,也就是建立一张 WF index →(原子、轨道类型、位置) 的映射表。没有这张表,你从 wannier90\_\allowbreak{}hr.dat 抽出来的矩阵元只是数字,没法说清它对应 Tc–Se、Se–Ir 还是 Tc–Tc 的哪条路径。\par


准备文件\par


\begin{codeindexbox}{代码清单 A.59.1}
语言：python；完整代码见附录第 \pageref{code:59:1} 页，共 3 行。
\end{codeindexbox}
...
(2) Step2 的本质是:把 wannier90\_\allowbreak{}hr.dat 里的 Hmn(R)变成“带几何距离的 hopping 列表”,再按你关心的子空间对(Tc–Tc、Tc–Se、Se–Ir...)和壳层做统计。\par
...
语言：python；完整代码见附录第 \pageref{code:59:2} 页，共 3 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.59.3}
语言：python；完整代码见附录第 \pageref{code:59:3} 页，共 2 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:59:4} 页，共 358 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.59.5}
语言：shell；完整代码见附录第 \pageref{code:59:5} 页，共 2 行。
\end{codeindexbox}
...
(3)读取你已经生成的 2step.csv(跨原子 edges),自动筛选 Tc–Se 与 Se–Ir 的近邻 hopping,构 造 Tc → Se → Ir → Se → Tc 的候选“超超交换路径”,并按路径权重排序输出一个csv文件。\par
...
语言：python；完整代码见附录第 \pageref{code:59:6} 页，共 272 行。
\end{codeindexbox}


运行方法(针对你当前文件名:2step.csv):\par


\begin{codeindexbox}{代码清单 A.59.7}
语言：shell；完整代码见附录第 \pageref{code:59:7} 页，共 7 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:59:8} 页，共 8 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.59.9}
语言：python；完整代码见附录第 \pageref{code:59:9} 页，共 266 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.59.10}
语言：shell；完整代码见附录第 \pageref{code:59:10} 页，共 1 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.59.11}
语言：shell；完整代码见附录第 \pageref{code:59:11} 页，共 1 行。
\end{codeindexbox}
...
(4)根据你想要探究的目的,超超交换路径是通过提供铁电性的迁移原子 Ge 还是非磁性原子 Ir 来主导, 我们可以修改脚本,让它在输出路径时能够分别计算 Ge 和 Ir 路径的贡献,并将这些路径的 权重贡献 和参与原子频率明确标识出来。\par


这一步与(3)不矛盾,但代码有所不同,选择(4)也许更准一些。\par


\begin{codeindexbox}{代码清单 A.59.12}
语言：python；完整代码见附录第 \pageref{code:59:12} 页，共 225 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:59:13} 页，共 47 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.59.14}
语言：shell；完整代码见附录第 \pageref{code:59:14} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.59.15}
语言：shell；完整代码见附录第 \pageref{code:59:15} 页，共 3 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.59.16}
语言：shell；完整代码见附录第 \pageref{code:59:16} 页，共 7 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.59.17}
语言：shell；完整代码见附录第 \pageref{code:59:17} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.59.18}
语言：shell；完整代码见附录第 \pageref{code:59:18} 页，共 5 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:60:1} 页，共 6 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.60.2}
语言：python；完整代码见附录第 \pageref{code:60:2} 页，共 537 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.60.3}
语言：python；完整代码见附录第 \pageref{code:60:3} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.60.4}
语言：shell；完整代码见附录第 \pageref{code:60:4} 页，共 2 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.60.5}
语言：python；完整代码见附录第 \pageref{code:60:5} 页，共 431 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.60.6}
语言：python；完整代码见附录第 \pageref{code:60:6} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.61.1}
语言：shell；完整代码见附录第 \pageref{code:61:1} 页，共 1 行。
\end{codeindexbox}
...
之前的脚本里虽然已经做了 WF centre → 最近原子(PBC minimum image)的映射(map\_\allowbreak{}wf\_\allowbreak{}to\_\allowbreak{}atoms),但真正用于分组(Tc\_\allowbreak{}d/\allowbreak{}Ir\_\allowbreak{}d/\allowbreak{}Se\_\allowbreak{}p/\allowbreak{}Ge\_\allowbreak{}p)的仍然是硬编码的 WF 序号区间 wf\_\allowbreak{}group。并且在主循环里 gm = wf\_\allowbreak{}group(m), gn = wf\_\allowbreak{}group(n) 也仍然走的是这个硬编码逻辑。这就导致:只要你换了投影顺序、num\_\allowbreak{}wann、spin 通道、或者 Wannier 重排,分组 就会错——因此”之前修改是否正确”的结论是:核心问题没有被真正修掉(最近原子映射算出来了,但没用来分组)。\par


下面我把你这份脚本做了”最小但关键”的正确修复:删除 wf\_\allowbreak{}group(wf) 的”WF 序号区间分组”(这是不可靠的根源),改为:对每条 hopping,先用你已计算出的 elem\_\allowbreak{}m/\allowbreak{}elem\_\allowbreak{}n(来自最 近原子映射),再进行无向格式(便于做壳层统计),同时在 out\_\allowbreak{}edges 里额外写出 group\_\allowbreak{}m/\allowbreak{}group\_\allowbreak{}n,方便你后续 2step 做筛选。\par


\begin{codeindexbox}{代码清单 A.61.2}
语言：python；完整代码见附录第 \pageref{code:61:2} 页，共 403 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.61.3}
语言：python；完整代码见附录第 \pageref{code:61:3} 页，共 2 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:61:4} 页，共 387 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.61.5}
语言：python；完整代码见附录第 \pageref{code:61:5} 页，共 2 行。
\end{codeindexbox}
...
在参数设置上,默认 hund\_\allowbreak{}coef取值为 2(对应更合理的 U + 2JH形式,这是考虑到体系中 d 轨道呈 2+2+1 分裂的实际情况,因此不建议默认使用 4)。同时,保留了 –hund\_\allowbreak{}coef参数供您 调节,可以运行 1、2、4 等不同取值以进行敏感性分析。\par
...
语言：python；完整代码见附录第 \pageref{code:61:6} 页，共 472 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.61.7}
语言：python；完整代码见附录第 \pageref{code:61:7} 页，共 2 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:61:8} 页，共 140 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.61.9}
语言：python；完整代码见附录第 \pageref{code:61:9} 页，共 2 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:61:10} 页，共 2 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:61:11} 页，共 87 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:61:12} 页，共 2 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:61:13} 页，共 122 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.61.14}
语言：python；完整代码见附录第 \pageref{code:61:14} 页，共 2 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:62:1} 页，共 298 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:62:2} 页，共 3 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.63.1}
语言：shell；完整代码见附录第 \pageref{code:63:1} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.63.2}
语言：python；完整代码见附录第 \pageref{code:63:2} 页，共 351 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.63.3}
语言：shell；完整代码见附录第 \pageref{code:63:3} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.63.4}
语言：python；完整代码见附录第 \pageref{code:63:4} 页，共 96 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.63.5}
语言：python；完整代码见附录第 \pageref{code:63:5} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.63.6}
语言：python；完整代码见附录第 \pageref{code:63:6} 页，共 270 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.63.7}
语言：shell；完整代码见附录第 \pageref{code:63:7} 页，共 2 行。
\end{codeindexbox}
...
collect\_\allowbreak{}elem\_\allowbreak{}orbital\_\allowbreak{}distributions.py脚本是用于分析材料中元素轨道能量分布的专业工具。其核心功能是基于包含全轨道权重的能级数据(*\_\allowbreak{}levels\_\allowbreak{}fullweights.csv),对每个元 素的各个轨道(如 Se 的 px、py、pz)进行加权统计,这完美解决了你之前提出的“分析Se的px/\allowbreak{}py/\allowbreak{}pz整体分布”的需求。\par
...
\begin{codeindexbox}{代码清单 A.63.8}
语言：python；完整代码见附录第 \pageref{code:63:8} 页，共 120 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.63.9}
语言：shell；完整代码见附录第 \pageref{code:63:9} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.63.10}
语言：python；完整代码见附录第 \pageref{code:63:10} 页，共 89 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.63.11}
语言：python；完整代码见附录第 \pageref{code:63:11} 页，共 85 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.63.12}
语言：shell；完整代码见附录第 \pageref{code:63:12} 页，共 11 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.63.13}
语言：python；完整代码见附录第 \pageref{code:63:13} 页，共 584 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.63.14}
语言：shell；完整代码见附录第 \pageref{code:63:14} 页，共 4 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.63.15}
语言：python；完整代码见附录第 \pageref{code:63:15} 页，共 3 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.63.16}
语言：python；完整代码见附录第 \pageref{code:63:16} 页，共 122 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.63.17}
语言：shell；完整代码见附录第 \pageref{code:63:17} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.63.18}
语言：python；完整代码见附录第 \pageref{code:63:18} 页，共 209 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.63.19}
语言：shell；完整代码见附录第 \pageref{code:63:19} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.64.1}
语言：python；完整代码见附录第 \pageref{code:64:1} 页，共 376 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.64.2}
语言：shell；完整代码见附录第 \pageref{code:64:2} 页，共 9 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.64.3}
语言：python；完整代码见附录第 \pageref{code:64:3} 页，共 362 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.64.4}
语言：shell；完整代码见附录第 \pageref{code:64:4} 页，共 9 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.64.5}
语言：python；完整代码见附录第 \pageref{code:64:5} 页，共 385 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.64.6}
语言：shell；完整代码见附录第 \pageref{code:64:6} 页，共 3 行。
\end{codeindexbox}
...
\item 新版清洗脚本可以兼容你这批 \texttt{hr.dat} 的真实格式
\end{itemize}
...
你当前做的不是“随便训练一个分类器”,而是围绕 Lieb lattice 的 8 参数最小模型,建立一个具有物理可解释性的机器学习代理框架,用来做两件事:\par
...
你当前研究对象是 Lieb lattice 的 8 参数最小模型,参数为:\par
...
这套变量不是随便定义的,而是来自该类模型的最小 TB /\allowbreak{} MagneticTB 描述。你上传的文章与支撑材料中,已经给出这 8 参数最小模型的解析形式,并说明:\par
...
\item 你当前第二应用讨论的是:\texttt{topological classification /\allowbreak{} phase boundary /\allowbreak{} boundary structure} 的全局统计控制规律
\end{itemize}
...
你确认过 \texttt{add\_\allowbreak{}signed\_\allowbreak{}features(df)} 在 09 开头的训练 levelB 脚本中,具体文件为:\par
...
虽然全局上 \texttt{r-family} 更强,但你最终相图和多轮 refine 都落在 \texttt{t2-r3} 平面上,因此:\par
...
当前最稳妥、最不容易与文献矛盾、也最符合你机器学习输出的结论是:\par
...
你已经不只是得到了一个能预测 topo 的代理模型,而是得到了一个可以在 Lieb lattice 8 参数最小模型上识别参数主导结构、解释为何相图主平面落在 \texttt{t2-r3}、并证明 \texttt{boundary} 为真实宽过渡带的可解释机器学习框架。\par
...
语言：python；完整代码见附录第 \pageref{code:70:1} 页，共 677 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.70.2}
语言：shell；完整代码见附录第 \pageref{code:70:2} 页，共 8 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.70.3}
语言：shell；完整代码见附录第 \pageref{code:70:3} 页，共 2 行。
\end{codeindexbox}
...
脚本的原理是,根据数组创建与材料名称一一对应的文件夹,并复制POSCAR,同时读取文件夹名称中的元素,再替换进POSCAR对应的元素行,这样就能基于这一结构进行高通量计算,要注意的是,必须得是你想要的结构的POSCAR。\par
...
语言：shell；完整代码见附录第 \pageref{code:71:1} 页，共 30 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:71:2} 页，共 75 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.71.3}
语言：shell；完整代码见附录第 \pageref{code:71:3} 页，共 59 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.71.4}
语言：shell；完整代码见附录第 \pageref{code:71:4} 页，共 76 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.71.5}
语言：shell；完整代码见附录第 \pageref{code:71:5} 页，共 172 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:72:1} 页，共 11 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:73:1} 页，共 303 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:73:2} 页，共 113 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:74:1} 页，共 121 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:75:1} 页，共 21 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.75.2}
语言：python；完整代码见附录第 \pageref{code:75:2} 页，共 557 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.76.1}
语言：python；完整代码见附录第 \pageref{code:76:1} 页，共 652 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.76.2}
语言：python；完整代码见附录第 \pageref{code:76:2} 页，共 622 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:76:3} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.76.4}
语言：shell；完整代码见附录第 \pageref{code:76:4} 页，共 2 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:77:1} 页，共 26 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.78.1}
语言：shell；完整代码见附录第 \pageref{code:78:1} 页，共 4 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.78.2}
语言：shell；完整代码见附录第 \pageref{code:78:2} 页，共 3 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.78.3}
语言：shell；完整代码见附录第 \pageref{code:78:3} 页，共 6 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:78:4} 页，共 3 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.78.5}
语言：python；完整代码见附录第 \pageref{code:78:5} 页，共 28 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.78.6}
语言：shell；完整代码见附录第 \pageref{code:78:6} 页，共 13 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.78.7}
语言：shell；完整代码见附录第 \pageref{code:78:7} 页，共 11 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.78.8}
语言：python；完整代码见附录第 \pageref{code:78:8} 页，共 119 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.78.9}
语言：python；完整代码见附录第 \pageref{code:78:9} 页，共 186 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.78.10}
语言：python；完整代码见附录第 \pageref{code:78:10} 页，共 195 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.78.11}
语言：python；完整代码见附录第 \pageref{code:78:11} 页，共 128 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:79:1} 页，共 89 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:80:1} 页，共 2 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:80:2} 页，共 2 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.80.3}
语言：shell；完整代码见附录第 \pageref{code:80:3} 页，共 2 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:80:4} 页，共 7 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:80:5} 页，共 2 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.80.6}
语言：shell；完整代码见附录第 \pageref{code:80:6} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.81.1}
语言：python；完整代码见附录第 \pageref{code:81:1} 页，共 425 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.81.2}
语言：shell；完整代码见附录第 \pageref{code:81:2} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.81.3}
语言：python；完整代码见附录第 \pageref{code:81:3} 页，共 488 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.81.4}
语言：shell；完整代码见附录第 \pageref{code:81:4} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.81.5}
语言：python；完整代码见附录第 \pageref{code:81:5} 页，共 482 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.81.6}
语言：python；完整代码见附录第 \pageref{code:81:6} 页，共 2 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.81.7}
语言：python；完整代码见附录第 \pageref{code:81:7} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.81.8}
语言：python；完整代码见附录第 \pageref{code:81:8} 页，共 523 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.82.1}
语言：python；完整代码见附录第 \pageref{code:82:1} 页，共 3 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:82:2} 页，共 38 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:82:3} 页，共 33 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:82:4} 页，共 63 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:82:5} 页，共 85 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:84:1} 页，共 2 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:84:2} 页，共 2 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:84:3} 页，共 1 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:84:4} 页，共 2 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:84:5} 页，共 56 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:84:6} 页，共 58 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:84:7} 页，共 2 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:84:8} 页，共 24 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:84:9} 页，共 13 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:84:10} 页，共 20 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.84.11}
语言：python；完整代码见附录第 \pageref{code:84:11} 页，共 9 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:84:12} 页，共 229 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:84:13} 页，共 2 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:84:14} 页，共 45 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:84:15} 页，共 62 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:84:16} 页，共 28 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:84:17} 页，共 177 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:84:18} 页，共 55 行。
\end{codeindexbox}
...
语言：python；完整代码见附录第 \pageref{code:84:19} 页，共 177 行。
\end{codeindexbox}
...
语言：shell；完整代码见附录第 \pageref{code:85:1} 页，共 9 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.85.2}
语言：python；完整代码见附录第 \pageref{code:85:2} 页，共 127 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.85.3}
语言：python；完整代码见附录第 \pageref{code:85:3} 页，共 162 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.85.4}
语言：python；完整代码见附录第 \pageref{code:85:4} 页，共 69 行。
\end{codeindexbox}


(6) 记住上一步输出的ROI这一行内容,计算想要绘制的区域的坐标,同时记得修改你的png和csv文件名。\par


\begin{codeindexbox}{代码清单 A.85.5}
语言：shell；完整代码见附录第 \pageref{code:85:5} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.85.6}
语言：python；完整代码见附录第 \pageref{code:85:6} 页，共 42 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.85.7}
语言：python；完整代码见附录第 \pageref{code:85:7} 页，共 42 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.85.8}
语言：shell；完整代码见附录第 \pageref{code:85:8} 页，共 4 行。
\end{codeindexbox}


\begin{codeindexbox}{代码清单 A.85.9}
语言：python；完整代码见附录第 \pageref{code:85:9} 页，共 48 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.85.10}
语言：python；完整代码见附录第 \pageref{code:85:10} 页，共 44 行。
\end{codeindexbox}


(10)下方是blender代码,要把blender工程文件和你的上面的输出文件放到同一个文件夹。\par


这个是抠图版的代码,只绘制斯格明子本身\par


\begin{codeindexbox}{代码清单 A.85.11}
语言：python；完整代码见附录第 \pageref{code:85:11} 页，共 44 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.85.12}
语言：python；完整代码见附录第 \pageref{code:85:12} 页，共 44 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.1}
语言：text；完整代码见附录第 \pageref{code:86:1} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.2}
语言：text；完整代码见附录第 \pageref{code:86:2} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.3}
语言：text；完整代码见附录第 \pageref{code:86:3} 页，共 9 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.4}
语言：text；完整代码见附录第 \pageref{code:86:4} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.5}
语言：text；完整代码见附录第 \pageref{code:86:5} 页，共 3 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.6}
语言：text；完整代码见附录第 \pageref{code:86:6} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.7}
语言：text；完整代码见附录第 \pageref{code:86:7} 页，共 11 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.8}
语言：text；完整代码见附录第 \pageref{code:86:8} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.9}
语言：text；完整代码见附录第 \pageref{code:86:9} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.10}
语言：text；完整代码见附录第 \pageref{code:86:10} 页，共 5 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.11}
语言：text；完整代码见附录第 \pageref{code:86:11} 页，共 3 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.12}
语言：text；完整代码见附录第 \pageref{code:86:12} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.13}
语言：text；完整代码见附录第 \pageref{code:86:13} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.14}
语言：text；完整代码见附录第 \pageref{code:86:14} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.15}
语言：text；完整代码见附录第 \pageref{code:86:15} 页，共 5 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.16}
语言：text；完整代码见附录第 \pageref{code:86:16} 页，共 5 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.17}
语言：text；完整代码见附录第 \pageref{code:86:17} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.18}
语言：text；完整代码见附录第 \pageref{code:86:18} 页，共 5 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.19}
语言：text；完整代码见附录第 \pageref{code:86:19} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.20}
语言：text；完整代码见附录第 \pageref{code:86:20} 页，共 5 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.21}
语言：text；完整代码见附录第 \pageref{code:86:21} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.22}
语言：text；完整代码见附录第 \pageref{code:86:22} 页，共 5 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.23}
语言：text；完整代码见附录第 \pageref{code:86:23} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.24}
语言：text；完整代码见附录第 \pageref{code:86:24} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.25}
语言：text；完整代码见附录第 \pageref{code:86:25} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.26}
语言：text；完整代码见附录第 \pageref{code:86:26} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.27}
语言：text；完整代码见附录第 \pageref{code:86:27} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.28}
语言：text；完整代码见附录第 \pageref{code:86:28} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.29}
语言：text；完整代码见附录第 \pageref{code:86:29} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.30}
语言：text；完整代码见附录第 \pageref{code:86:30} 页，共 5 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.31}
语言：text；完整代码见附录第 \pageref{code:86:31} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.32}
语言：text；完整代码见附录第 \pageref{code:86:32} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.33}
语言：text；完整代码见附录第 \pageref{code:86:33} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.34}
语言：text；完整代码见附录第 \pageref{code:86:34} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.35}
语言：text；完整代码见附录第 \pageref{code:86:35} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.36}
语言：text；完整代码见附录第 \pageref{code:86:36} 页，共 2 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.37}
语言：text；完整代码见附录第 \pageref{code:86:37} 页，共 5 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.38}
语言：text；完整代码见附录第 \pageref{code:86:38} 页，共 8 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.39}
语言：text；完整代码见附录第 \pageref{code:86:39} 页，共 21 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.40}
语言：text；完整代码见附录第 \pageref{code:86:40} 页，共 8 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.86.41}
语言：text；完整代码见附录第 \pageref{code:86:41} 页，共 1 行。
\end{codeindexbox}
...
\begin{codeindexbox}{代码清单 A.87.1}
语言：python；完整代码见附录第 \pageref{code:87:1} 页，共 197 行。
\end{codeindexbox}
...
\appendix
\chapter{完整代码清单}
本附录按正文文章号排序，完整保留原始代码。每个代码块同时保存为工程 \texttt{code/} 目录中的独立 UTF-8 文件，便于复制、检索与复现。
\section*{vasp计算态密度}
...
\subsection*{代码清单 A.2.2（python，659 行）}
...
\subsection*{代码清单 A.2.3（python，71 行）}
...
\subsection*{代码清单 A.2.4（python，652 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/002-004.py}
\medskip
\phantomsection\label{code:2:5}
\subsection*{代码清单 A.2.5（python，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/002-005.py}
\medskip
\section*{vasp计算能带}
...
\subsection*{代码清单 A.4.1（shell，41 行）}
...
\subsection*{代码清单 A.4.2（shell，41 行）}
...
\subsection*{代码清单 A.4.3（shell，41 行）}
...
\subsection*{代码清单 A.4.4（shell，41 行）}
...
\subsection*{代码清单 A.4.5（shell，42 行）}
...
\subsection*{代码清单 A.4.6（shell，48 行）}
...
\subsection*{代码清单 A.4.7（shell，42 行）}
...
\subsection*{代码清单 A.4.8（shell，42 行）}
...
\subsection*{代码清单 A.4.9（shell，42 行）}
...
\subsection*{代码清单 A.4.10（shell，52 行）}
...
\subsection*{代码清单 A.5.2（shell，40 行）}
...
\subsection*{代码清单 A.5.3（shell，47 行）}
...
\subsection*{代码清单 A.7.1（shell，23 行）}
...
\subsection*{代码清单 A.7.2（shell，28 行）}
...
\subsection*{代码清单 A.8.1（shell，4 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/008-001.sh}
\medskip
\section*{以Bi烯为例的wannier90表面态计算}
\phantomsection\label{code:9:1}
\subsection*{代码清单 A.9.1（shell，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/009-001.sh}
\medskip
\phantomsection\label{code:9:2}
\subsection*{代码清单 A.9.2（shell，32 行）}
...
\medskip
\phantomsection\label{code:9:5}
\subsection*{代码清单 A.9.5（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/009-005.sh}
\medskip
\phantomsection\label{code:9:6}
\subsection*{代码清单 A.9.6（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/009-006.sh}
\medskip
\phantomsection\label{code:9:7}
\subsection*{代码清单 A.9.7（shell，64 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/009-007.sh}
\medskip
\phantomsection\label{code:9:8}
\subsection*{代码清单 A.9.8（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/009-008.sh}
\medskip
\phantomsection\label{code:9:9}
\subsection*{代码清单 A.9.9（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/009-009.sh}
\medskip
\phantomsection\label{code:9:10}
\subsection*{代码清单 A.9.10（shell，5 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/009-010.sh}
\medskip
\phantomsection\label{code:9:11}
\subsection*{代码清单 A.9.11（shell，64 行）}
...
\subsection*{代码清单 A.9.12（shell，58 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/009-012.sh}
\medskip
\phantomsection\label{code:9:13}
\subsection*{代码清单 A.9.13（shell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/009-013.sh}
\medskip
\section*{Wannier90的表面态的参数选择标准1\_\allowbreak{}示例文件的参数注释}
\phantomsection\label{code:11:1}
\subsection*{代码清单 A.11.1（shell，64 行）}
...
\subsection*{代码清单 A.11.2（shell，11 行）}
...
\subsection*{代码清单 A.11.3（shell，5 行）}
...
\subsection*{代码清单 A.11.4（shell，6 行）}
...
\subsection*{代码清单 A.11.5（shell，5 行）}
...
\subsection*{代码清单 A.20.2（shell，44 行）}
...
\subsection*{代码清单 A.20.3（shell，12 行）}
...
\subsection*{代码清单 A.20.4（shell，43 行）}
...
\subsection*{代码清单 A.20.5（shell，16 行）}
...
\subsection*{代码清单 A.20.6（shell，55 行）}
...
\subsection*{代码清单 A.20.7（shell，11 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/020-007.sh}
\medskip
\section*{pyw90的测试用例}
\phantomsection\label{code:21:1}
\subsection*{代码清单 A.21.1（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/021-001.sh}
\medskip
\phantomsection\label{code:21:2}
\subsection*{代码清单 A.21.2（shell，9 行）}
...
\subsection*{代码清单 A.21.3（shell，16 行）}
...
\subsection*{代码清单 A.21.4（shell，2 行）}
...
\subsection*{代码清单 A.21.5（shell，24 行）}
...
\subsection*{代码清单 A.21.6（shell，2 行）}
...
\subsection*{代码清单 A.21.7（shell，25 行）}
...
\subsection*{代码清单 A.21.8（shell，3 行）}
...
\subsection*{代码清单 A.21.9（shell，79 行）}
...
\subsection*{代码清单 A.21.10（shell，2 行）}
...
\subsection*{代码清单 A.21.11（shell，77 行）}
...
\subsection*{代码清单 A.21.12（shell，2 行）}
...
\subsection*{代码清单 A.21.13（shell，36 行）}
...
\subsection*{代码清单 A.21.14（shell，13 行）}
...
\subsection*{代码清单 A.21.15（shell，13 行）}
...
\subsection*{代码清单 A.21.16（shell，14 行）}
...
\subsection*{代码清单 A.21.17（shell，2 行）}
...
\subsection*{代码清单 A.21.20（shell，43 行）}
...
\subsection*{代码清单 A.21.21（shell，2 行）}
...
\subsection*{代码清单 A.21.22（shell，2 行）}
...
\subsection*{代码清单 A.21.23（shell，2 行）}
...
\subsection*{代码清单 A.22.1（shell，21 行）}
...
\subsection*{代码清单 A.22.2（shell，2 行）}
...
\subsection*{代码清单 A.22.3（shell，2 行）}
...
\subsection*{代码清单 A.22.4（shell，2 行）}
...
\subsection*{代码清单 A.22.5（shell，2 行）}
...
\subsection*{代码清单 A.22.6（shell，2 行）}
...
\subsection*{代码清单 A.22.7（shell，2 行）}
...
\subsection*{代码清单 A.23.1（fortran，2052 行）}
...
\subsection*{代码清单 A.23.2（fortran，291 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/023-002.f90}
\medskip
\section*{wannierberrier的安装}
\phantomsection\label{code:24:1}
\subsection*{代码清单 A.24.1（shell，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/024-001.sh}
\medskip
...
\medskip
\phantomsection\label{code:24:3}
\subsection*{代码清单 A.24.3（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/024-003.sh}
\medskip
\phantomsection\label{code:24:4}
\subsection*{代码清单 A.24.4（shell，94 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/024-004.sh}
\medskip
\section*{wansymm的对称化功能}
\phantomsection\label{code:25:1}
\subsection*{代码清单 A.25.1（shell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/025-001.sh}
\medskip
\phantomsection\label{code:25:2}
\subsection*{代码清单 A.25.2（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/025-002.sh}
\medskip
\phantomsection\label{code:25:3}
\subsection*{代码清单 A.25.3（shell，4 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/025-003.sh}
\medskip
\phantomsection\label{code:25:4}
\subsection*{代码清单 A.25.4（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/025-004.sh}
\medskip
\phantomsection\label{code:25:5}
\subsection*{代码清单 A.25.5（python，20 行）}
...
\subsection*{代码清单 A.25.6（python，10 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/025-006.py}
\medskip
\section*{利用Wannier Tools的对称化hr.dat}
\phantomsection\label{code:26:1}
\subsection*{代码清单 A.26.1（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/026-001.sh}
\medskip
\phantomsection\label{code:26:2}
\subsection*{代码清单 A.26.2（shell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/026-002.sh}
\medskip
\phantomsection\label{code:26:3}
\subsection*{代码清单 A.26.3（python，25 行）}
...
\subsection*{代码清单 A.26.4（python，14 行）}
...
\subsection*{代码清单 A.26.5（python，31 行）}
...
\subsection*{代码清单 A.26.6（python，72 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/026-006.py}
\medskip
\phantomsection\label{code:26:7}
\subsection*{代码清单 A.26.7（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/026-007.sh}
\medskip
\phantomsection\label{code:26:8}
\subsection*{代码清单 A.26.8（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/026-008.sh}
\medskip
\section*{TB2J新版测试}
\phantomsection\label{code:28:1}
\subsection*{代码清单 A.28.1（shell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/028-001.sh}
\medskip
\phantomsection\label{code:28:2}
\subsection*{代码清单 A.28.2（shell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/028-002.sh}
\medskip
\phantomsection\label{code:28:3}
\subsection*{代码清单 A.28.3（shell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/028-003.sh}
\medskip
\phantomsection\label{code:28:4}
\subsection*{代码清单 A.28.4（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/028-004.sh}
\medskip
\phantomsection\label{code:28:5}
\subsection*{代码清单 A.28.5（shell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/028-005.sh}
\medskip
\phantomsection\label{code:28:6}
\subsection*{代码清单 A.28.6（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/028-006.sh}
\medskip
\phantomsection\label{code:28:7}
\subsection*{代码清单 A.28.7（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/028-007.sh}
\medskip
\phantomsection\label{code:28:8}
\subsection*{代码清单 A.28.8（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/028-008.sh}
\medskip
\phantomsection\label{code:28:9}
\subsection*{代码清单 A.28.9（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/028-009.sh}
\medskip
\phantomsection\label{code:28:10}
\subsection*{代码清单 A.28.10（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/028-010.sh}
\medskip
\phantomsection\label{code:28:11}
\subsection*{代码清单 A.28.11（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/028-011.sh}
\medskip
\phantomsection\label{code:28:12}
\subsection*{代码清单 A.28.12（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/028-012.sh}
\medskip
\section*{TB2J新版测试}
\phantomsection\label{code:29:1}
\subsection*{代码清单 A.29.1（shell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/029-001.sh}
\medskip
\phantomsection\label{code:29:2}
\subsection*{代码清单 A.29.2（shell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/029-002.sh}
\medskip
\phantomsection\label{code:29:3}
\subsection*{代码清单 A.29.3（shell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/029-003.sh}
\medskip
\phantomsection\label{code:29:4}
\subsection*{代码清单 A.29.4（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/029-004.sh}
\medskip
\phantomsection\label{code:29:5}
\subsection*{代码清单 A.29.5（shell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/029-005.sh}
\medskip
\phantomsection\label{code:29:6}
\subsection*{代码清单 A.29.6（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/029-006.sh}
\medskip
\phantomsection\label{code:29:7}
\subsection*{代码清单 A.29.7（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/029-007.sh}
\medskip
\phantomsection\label{code:29:8}
\subsection*{代码清单 A.29.8（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/029-008.sh}
\medskip
\phantomsection\label{code:29:9}
\subsection*{代码清单 A.29.9（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/029-009.sh}
\medskip
\section*{pythTB的学习\_\allowbreak{}Parameterized\_\allowbreak{}TBModel}
\phantomsection\label{code:30:1}
\subsection*{代码清单 A.30.1（python，3 行）}
...
\subsection*{代码清单 A.30.2（python，14 行）}
...
\subsection*{代码清单 A.30.3（python，2 行）}
...
\subsection*{代码清单 A.30.4（python，2 行）}
...
\subsection*{代码清单 A.30.5（python，2 行）}
...
\subsection*{代码清单 A.30.6（python，41 行）}
...
\subsection*{代码清单 A.30.8（python，2 行）}
...
\subsection*{代码清单 A.30.9（python，14 行）}
...
\subsection*{代码清单 A.30.10（python，5 行）}
...
\subsection*{代码清单 A.30.11（python，8 行）}
...
\subsection*{代码清单 A.30.12（python，5 行）}
...
\subsection*{代码清单 A.30.13（python，8 行）}
...
\subsection*{代码清单 A.30.14（python，5 行）}
...
\subsection*{代码清单 A.30.15（python，3 行）}
...
\subsection*{代码清单 A.30.16（python，2 行）}
...
\subsection*{代码清单 A.30.17（python，43 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/030-017.py}
\medskip
\phantomsection\label{code:30:18}
\subsection*{代码清单 A.30.18（python，4 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/030-018.py}
\medskip
\phantomsection\label{code:30:19}
\subsection*{代码清单 A.30.19（python，3 行）}
...
\subsection*{代码清单 A.30.20（python，18 行）}
...
\subsection*{代码清单 A.30.21（python，4 行）}
...
\subsection*{代码清单 A.30.22（python，11 行）}
...
\subsection*{代码清单 A.30.23（python，39 行）}
...
\subsection*{代码清单 A.30.24（python，4 行）}
...
\subsection*{代码清单 A.30.25（python，39 行）}
...
\subsection*{代码清单 A.30.26（python，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/030-026.py}
\medskip
\section*{pythTB的学习\_\allowbreak{}lattice类}
\phantomsection\label{code:31:1}
\subsection*{代码清单 A.31.1（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/031-001.sh}
\medskip
\phantomsection\label{code:31:2}
\subsection*{代码清单 A.31.2（python，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/031-002.py}
\medskip
\phantomsection\label{code:31:3}
\subsection*{代码清单 A.31.3（python，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/031-003.py}
\medskip
\phantomsection\label{code:31:4}
\subsection*{代码清单 A.31.4（python，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/031-004.py}
\medskip
\phantomsection\label{code:31:5}
\subsection*{代码清单 A.31.5（python，27 行）}
...
\subsection*{代码清单 A.31.6（python，2 行）}
...
\subsection*{代码清单 A.31.7（python，3 行）}
...
\subsection*{代码清单 A.31.8（python，3 行）}
...
\subsection*{代码清单 A.31.9（python，5 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/031-009.py}
\medskip
\phantomsection\label{code:31:10}
\subsection*{代码清单 A.31.10（python，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/031-010.py}
\medskip
\phantomsection\label{code:31:11}
\subsection*{代码清单 A.31.11（python，3 行）}
...
\subsection*{代码清单 A.31.12（python，2 行）}
...
\subsection*{代码清单 A.31.13（python，2 行）}
...
\subsection*{代码清单 A.31.14（python，91 行）}
...
\subsection*{代码清单 A.32.1（python，3 行）}
...
\subsection*{代码清单 A.32.2（python，6 行）}
...
\subsection*{代码清单 A.32.3（python，4 行）}
...
\subsection*{代码清单 A.32.4（python，13 行）}
...
\subsection*{代码清单 A.32.5（python，2 行）}
...
\subsection*{代码清单 A.32.6（python，10 行）}
...
\subsection*{代码清单 A.32.7（python，7 行）}
...
\subsection*{代码清单 A.32.8（python，10 行）}
...
\subsection*{代码清单 A.32.9（python，8 行）}
...
\subsection*{代码清单 A.32.10（python，10 行）}
...
\subsection*{代码清单 A.33.1（python，3 行）}
...
\subsection*{代码清单 A.33.2（python，7 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/033-002.py}
\medskip
\phantomsection\label{code:33:3}
\subsection*{代码清单 A.33.3（python，5 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/033-003.py}
\medskip
\phantomsection\label{code:33:4}
\subsection*{代码清单 A.33.4（python，15 行）}
...
\subsection*{代码清单 A.33.5（python，4 行）}
...
\subsection*{代码清单 A.33.6（python，8 行）}
...
\subsection*{代码清单 A.33.7（python，2 行）}
...
\subsection*{代码清单 A.33.8（python，53 行）}
...
\subsection*{代码清单 A.33.9（python，3 行）}
...
\subsection*{代码清单 A.33.10（python，4 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/033-010.py}
\medskip
\phantomsection\label{code:33:11}
\subsection*{代码清单 A.33.11（python，6 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/033-011.py}
\medskip
\phantomsection\label{code:33:12}
\subsection*{代码清单 A.33.12（python，8 行）}
...
\subsection*{代码清单 A.33.13（python，18 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/033-013.py}
\medskip
\phantomsection\label{code:33:14}
\subsection*{代码清单 A.33.14（python，5 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/033-014.py}
\medskip
\phantomsection\label{code:33:15}
\subsection*{代码清单 A.33.15（python，4 行）}
...
\subsection*{代码清单 A.33.16（python，3 行）}
...
\subsection*{代码清单 A.33.17（python，32 行）}
...
\subsection*{代码清单 A.33.18（python，53 行）}
...
\subsection*{代码清单 A.33.19（python，5 行）}
...
\subsection*{代码清单 A.34.1（python，6 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/034-001.py}
\medskip
\phantomsection\label{code:34:2}
\subsection*{代码清单 A.34.2（python，4 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/034-002.py}
\medskip
\phantomsection\label{code:34:3}
\subsection*{代码清单 A.34.3（python，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/034-003.py}
\medskip
\phantomsection\label{code:34:4}
\subsection*{代码清单 A.34.4（python，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/034-004.py}
\medskip
\phantomsection\label{code:34:5}
\subsection*{代码清单 A.34.5（python，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/034-005.py}
\medskip
\phantomsection\label{code:34:6}
\subsection*{代码清单 A.34.6（python，19 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/034-006.py}
\medskip
\phantomsection\label{code:34:7}
\subsection*{代码清单 A.34.7（python，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/034-007.py}
\medskip
\phantomsection\label{code:34:8}
\subsection*{代码清单 A.34.8（python，2 行）}
...
\subsection*{代码清单 A.34.9（python，7 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/034-009.py}
\medskip
\phantomsection\label{code:34:10}
\subsection*{代码清单 A.34.10（python，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/034-010.py}
\medskip
\phantomsection\label{code:34:11}
\subsection*{代码清单 A.34.11（python，8 行）}
...
\subsection*{代码清单 A.34.12（python，5 行）}
...
\subsection*{代码清单 A.34.13（python，11 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/034-013.py}
\medskip
\phantomsection\label{code:34:14}
\subsection*{代码清单 A.34.14（python，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/034-014.py}
\medskip
\phantomsection\label{code:34:15}
\subsection*{代码清单 A.34.15（python，2 行）}
...
\subsection*{代码清单 A.34.16（python，2 行）}
...
\subsection*{代码清单 A.34.17（python，2 行）}
...
\subsection*{代码清单 A.35.1（python，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/035-001.py}
\medskip
\phantomsection\label{code:35:2}
\subsection*{代码清单 A.35.2（python，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/035-002.py}
\medskip
\section*{ir2TB的学习}
\phantomsection\label{code:36:1}
\subsection*{代码清单 A.36.1（shell，2 行）}
...
\subsection*{代码清单 A.36.2（shell，2 行）}
...
\subsection*{代码清单 A.37.1（shell，2 行）}
...
\subsection*{代码清单 A.37.2（shell，2 行）}
...
\subsection*{代码清单 A.38.2（shell，8 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/038-002.sh}
\medskip
\phantomsection\label{code:38:3}
\subsection*{代码清单 A.38.3（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/038-003.sh}
\medskip
\phantomsection\label{code:38:4}
\subsection*{代码清单 A.38.4（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/038-004.sh}
\medskip
\phantomsection\label{code:38:5}
\subsection*{代码清单 A.38.5（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/038-005.sh}
\medskip
\phantomsection\label{code:38:6}
\subsection*{代码清单 A.38.6（shell，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/038-006.sh}
\medskip
...
\medskip
\section*{ubuntu中使用pybinding}
\phantomsection\label{code:39:1}
\subsection*{代码清单 A.39.1（shell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/039-001.sh}
\medskip
\section*{网站维护与操作手册}
...
\subsection*{代码清单 A.40.5（text，227 行）}
...
\subsection*{代码清单 A.40.6（text，5 行）}
...
\medskip
\phantomsection\label{code:41:4}
\subsection*{代码清单 A.41.4（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/041-004.txt}
\medskip
...
\medskip
\phantomsection\label{code:42:18}
\subsection*{代码清单 A.42.18（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/042-018.txt}
\medskip
...
\medskip
\section*{(原创自研)网站维护记录3}
\phantomsection\label{code:43:1}
\subsection*{代码清单 A.43.1（bat，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/043-001.txt}
\medskip
...
\medskip
\phantomsection\label{code:43:5}
\subsection*{代码清单 A.43.5（bat，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/043-005.txt}
\medskip
\phantomsection\label{code:43:6}
\subsection*{代码清单 A.43.6（bat，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/043-006.txt}
\medskip
\phantomsection\label{code:43:7}
\subsection*{代码清单 A.43.7（bat，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/043-007.txt}
\medskip
\phantomsection\label{code:43:8}
\subsection*{代码清单 A.43.8（bat，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/043-008.txt}
\medskip
\phantomsection\label{code:43:9}
\subsection*{代码清单 A.43.9（bat，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/043-009.txt}
\medskip
...
\medskip
\phantomsection\label{code:43:11}
\subsection*{代码清单 A.43.11（bat，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/043-011.txt}
\medskip
\phantomsection\label{code:43:12}
\subsection*{代码清单 A.43.12（bat，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/043-012.txt}
\medskip
...
\medskip
\phantomsection\label{code:43:17}
\subsection*{代码清单 A.43.17（bat，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/043-017.txt}
\medskip
\phantomsection\label{code:43:18}
\subsection*{代码清单 A.43.18（bat，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/043-018.txt}
\medskip
\phantomsection\label{code:43:19}
\subsection*{代码清单 A.43.19（bat，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/043-019.txt}
\medskip
\phantomsection\label{code:43:20}
\subsection*{代码清单 A.43.20（bat，4 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/043-020.txt}
\medskip
\phantomsection\label{code:43:21}
\subsection*{代码清单 A.43.21（bat，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/043-021.txt}
\medskip
\phantomsection\label{code:43:22}
\subsection*{代码清单 A.43.22（bat，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/043-022.txt}
\medskip
\phantomsection\label{code:43:23}
\subsection*{代码清单 A.43.23（bat，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/043-023.txt}
\medskip
\phantomsection\label{code:43:24}
\subsection*{代码清单 A.43.24（bat，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/043-024.txt}
\medskip
\phantomsection\label{code:43:25}
\subsection*{代码清单 A.43.25（bat，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/043-025.txt}
\medskip
\phantomsection\label{code:43:26}
\subsection*{代码清单 A.43.26（bat，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/043-026.txt}
\medskip
...
\medskip
\phantomsection\label{code:43:28}
\subsection*{代码清单 A.43.28（bat，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/043-028.txt}
\medskip
\phantomsection\label{code:43:29}
\subsection*{代码清单 A.43.29（bat，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/043-029.txt}
\medskip
...
\medskip
\phantomsection\label{code:43:34}
\subsection*{代码清单 A.43.34（bat，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/043-034.txt}
\medskip
\phantomsection\label{code:43:35}
\subsection*{代码清单 A.43.35（bat，4 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/043-035.txt}
\medskip
\phantomsection\label{code:43:36}
\subsection*{代码清单 A.43.36（bat，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/043-036.txt}
\medskip
\phantomsection\label{code:43:37}
\subsection*{代码清单 A.43.37（bat，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/043-037.txt}
\medskip
\phantomsection\label{code:43:38}
\subsection*{代码清单 A.43.38（bat，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/043-038.txt}
\medskip
\phantomsection\label{code:43:39}
\subsection*{代码清单 A.43.39（bat，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/043-039.txt}
\medskip
...
\medskip
\phantomsection\label{code:43:41}
\subsection*{代码清单 A.43.41（bat，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/043-041.txt}
\medskip
...
\medskip
\phantomsection\label{code:45:3}
\subsection*{代码清单 A.45.3（javascript，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/045-003.js}
\medskip
...
\subsection*{代码清单 A.46.1（text，22 行）}
...
\subsection*{代码清单 A.46.2（text，1 行）}
...
\subsection*{代码清单 A.46.3（text，18 行）}
...
\subsection*{代码清单 A.46.4（text，4 行）}
...
\subsection*{代码清单 A.46.5（text，6 行）}
...
\subsection*{代码清单 A.46.8（text，2 行）}
...
\subsection*{代码清单 A.46.9（text，2 行）}
...
\subsection*{代码清单 A.46.10（text，2 行）}
...
\subsection*{代码清单 A.46.11（text，2 行）}
...
\subsection*{代码清单 A.46.12（powershell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-012.ps1}
\medskip
\phantomsection\label{code:46:13}
\subsection*{代码清单 A.46.13（powershell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-013.ps1}
\medskip
...
\subsection*{代码清单 A.46.17（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-017.txt}
\medskip
\phantomsection\label{code:46:18}
\subsection*{代码清单 A.46.18（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-018.txt}
\medskip
...
\subsection*{代码清单 A.46.20（tex，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-020.tex}
\medskip
\phantomsection\label{code:46:21}
\subsection*{代码清单 A.46.21（tex，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-021.tex}
\medskip
...
\medskip
\phantomsection\label{code:46:23}
\subsection*{代码清单 A.46.23（powershell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-023.ps1}
\medskip
\phantomsection\label{code:46:24}
\subsection*{代码清单 A.46.24（powershell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-024.ps1}
\medskip
\phantomsection\label{code:46:25}
\subsection*{代码清单 A.46.25（text，14 行）}
...
\subsection*{代码清单 A.46.26（text，2 行）}
...
\subsection*{代码清单 A.46.27（tex，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-027.tex}
\medskip
\phantomsection\label{code:46:28}
\subsection*{代码清单 A.46.28（tex，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-028.tex}
\medskip
\phantomsection\label{code:46:29}
\subsection*{代码清单 A.46.29（tex，6 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-029.tex}
\medskip
\phantomsection\label{code:46:30}
\subsection*{代码清单 A.46.30（tex，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-030.tex}
\medskip
\phantomsection\label{code:46:31}
\subsection*{代码清单 A.46.31（tex，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-031.tex}
\medskip
\phantomsection\label{code:46:32}
\subsection*{代码清单 A.46.32（text，1 行）}
...
\subsection*{代码清单 A.46.33（powershell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-033.ps1}
\medskip
\phantomsection\label{code:46:34}
\subsection*{代码清单 A.46.34（text，1 行）}
...
\subsection*{代码清单 A.46.36（text，1 行）}
...
\subsection*{代码清单 A.46.40（yaml，8 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-040.yml}
\medskip
\phantomsection\label{code:46:41}
\subsection*{代码清单 A.46.41（yaml，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-041.yml}
\medskip
\phantomsection\label{code:46:42}
\subsection*{代码清单 A.46.42（text，7 行）}
...
\medskip
\phantomsection\label{code:46:44}
\subsection*{代码清单 A.46.44（yaml，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-044.yml}
\medskip
...
\subsection*{代码清单 A.46.46（powershell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-046.ps1}
\medskip
\phantomsection\label{code:46:47}
\subsection*{代码清单 A.46.47（powershell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-047.ps1}
\medskip
\phantomsection\label{code:46:48}
\subsection*{代码清单 A.46.48（text，1 行）}
...
\medskip
\phantomsection\label{code:46:51}
\subsection*{代码清单 A.46.51（powershell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-051.ps1}
\medskip
\phantomsection\label{code:46:52}
\subsection*{代码清单 A.46.52（powershell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-052.ps1}
\medskip
...
\subsection*{代码清单 A.46.54（powershell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-054.ps1}
\medskip
\phantomsection\label{code:46:55}
\subsection*{代码清单 A.46.55（powershell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-055.ps1}
\medskip
...
\subsection*{代码清单 A.46.57（powershell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-057.ps1}
\medskip
...
\medskip
\phantomsection\label{code:46:59}
\subsection*{代码清单 A.46.59（text，13 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-059.txt}
\medskip
\phantomsection\label{code:46:60}
\subsection*{代码清单 A.46.60（text，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-060.txt}
\medskip
\phantomsection\label{code:46:61}
\subsection*{代码清单 A.46.61（text，4 行）}
...
\subsection*{代码清单 A.46.63（markdown，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-063.txt}
\medskip
\phantomsection\label{code:46:64}
\subsection*{代码清单 A.46.64（markdown，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-064.txt}
\medskip
\phantomsection\label{code:46:65}
\subsection*{代码清单 A.46.65（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-065.txt}
\medskip
\phantomsection\label{code:46:66}
\subsection*{代码清单 A.46.66（text，1 行）}
...
\subsection*{代码清单 A.46.67（tex，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-067.tex}
\medskip
\phantomsection\label{code:46:68}
\subsection*{代码清单 A.46.68（text，1 行）}
...
\subsection*{代码清单 A.46.69（powershell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-069.ps1}
\medskip
\phantomsection\label{code:46:70}
\subsection*{代码清单 A.46.70（text，1 行）}
...
\subsection*{代码清单 A.46.71（powershell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-071.ps1}
\medskip
\phantomsection\label{code:46:72}
\subsection*{代码清单 A.46.72（text，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-072.txt}
\medskip
\phantomsection\label{code:46:73}
\subsection*{代码清单 A.46.73（powershell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-073.ps1}
\medskip
\phantomsection\label{code:46:74}
\subsection*{代码清单 A.46.74（powershell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-074.ps1}
\medskip
\phantomsection\label{code:46:75}
\subsection*{代码清单 A.46.75（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-075.txt}
\medskip
\phantomsection\label{code:46:76}
\subsection*{代码清单 A.46.76（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-076.txt}
\medskip
\phantomsection\label{code:46:77}
\subsection*{代码清单 A.46.77（tex，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-077.tex}
\medskip
\phantomsection\label{code:46:78}
\subsection*{代码清单 A.46.78（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-078.txt}
\medskip
\phantomsection\label{code:46:79}
\subsection*{代码清单 A.46.79（tex，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-079.tex}
\medskip
\phantomsection\label{code:46:80}
\subsection*{代码清单 A.46.80（tex，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-080.tex}
\medskip
\phantomsection\label{code:46:81}
\subsection*{代码清单 A.46.81（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-081.txt}
\medskip
\phantomsection\label{code:46:82}
\subsection*{代码清单 A.46.82（markdown，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-082.txt}
\medskip
\phantomsection\label{code:46:83}
\subsection*{代码清单 A.46.83（markdown，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-083.txt}
\medskip
\phantomsection\label{code:46:84}
\subsection*{代码清单 A.46.84（html，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-084.html}
\medskip
\phantomsection\label{code:46:85}
\subsection*{代码清单 A.46.85（markdown，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-085.txt}
\medskip
\phantomsection\label{code:46:86}
\subsection*{代码清单 A.46.86（powershell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-086.ps1}
\medskip
\phantomsection\label{code:46:87}
\subsection*{代码清单 A.46.87（powershell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-087.ps1}
\medskip
\phantomsection\label{code:46:88}
\subsection*{代码清单 A.46.88（text，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-088.txt}
\medskip
\phantomsection\label{code:46:89}
\subsection*{代码清单 A.46.89（powershell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-089.ps1}
\medskip
\phantomsection\label{code:46:90}
\subsection*{代码清单 A.46.90（text，11 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-090.txt}
\medskip
\phantomsection\label{code:46:91}
\subsection*{代码清单 A.46.91（text，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/046-091.txt}
\medskip
\section*{(建模流程)Materials Studio 2023 手动搭建 Cs3V9Te13 晶体结构}
\phantomsection\label{code:47:1}
\subsection*{代码清单 A.47.1（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-001.txt}
\medskip
\phantomsection\label{code:47:2}
\subsection*{代码清单 A.47.2（text，11 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-002.txt}
\medskip
\phantomsection\label{code:47:3}
\subsection*{代码清单 A.47.3（text，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-003.txt}
\medskip
\phantomsection\label{code:47:4}
\subsection*{代码清单 A.47.4（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-004.txt}
\medskip
\phantomsection\label{code:47:5}
\subsection*{代码清单 A.47.5（text，4 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-005.txt}
\medskip
\phantomsection\label{code:47:6}
\subsection*{代码清单 A.47.6（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-006.txt}
\medskip
\phantomsection\label{code:47:7}
\subsection*{代码清单 A.47.7（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-007.txt}
\medskip
\phantomsection\label{code:47:8}
\subsection*{代码清单 A.47.8（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-008.txt}
\medskip
\phantomsection\label{code:47:9}
\subsection*{代码清单 A.47.9（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-009.txt}
\medskip
\phantomsection\label{code:47:10}
\subsection*{代码清单 A.47.10（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-010.txt}
\medskip
\phantomsection\label{code:47:11}
\subsection*{代码清单 A.47.11（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-011.txt}
\medskip
\phantomsection\label{code:47:12}
\subsection*{代码清单 A.47.12（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-012.txt}
\medskip
\phantomsection\label{code:47:13}
\subsection*{代码清单 A.47.13（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-013.txt}
\medskip
\phantomsection\label{code:47:14}
\subsection*{代码清单 A.47.14（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-014.txt}
\medskip
\phantomsection\label{code:47:15}
\subsection*{代码清单 A.47.15（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-015.txt}
\medskip
\phantomsection\label{code:47:16}
\subsection*{代码清单 A.47.16（text，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-016.txt}
\medskip
\phantomsection\label{code:47:17}
\subsection*{代码清单 A.47.17（text，7 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-017.txt}
\medskip
\phantomsection\label{code:47:18}
\subsection*{代码清单 A.47.18（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-018.txt}
\medskip
\phantomsection\label{code:47:19}
\subsection*{代码清单 A.47.19（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-019.txt}
\medskip
\phantomsection\label{code:47:20}
\subsection*{代码清单 A.47.20（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-020.txt}
\medskip
\phantomsection\label{code:47:21}
\subsection*{代码清单 A.47.21（text，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-021.txt}
\medskip
\phantomsection\label{code:47:22}
\subsection*{代码清单 A.47.22（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-022.txt}
\medskip
\phantomsection\label{code:47:23}
\subsection*{代码清单 A.47.23（text，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-023.txt}
\medskip
\phantomsection\label{code:47:24}
\subsection*{代码清单 A.47.24（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-024.txt}
\medskip
\phantomsection\label{code:47:25}
\subsection*{代码清单 A.47.25（text，8 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-025.txt}
\medskip
\phantomsection\label{code:47:26}
\subsection*{代码清单 A.47.26（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-026.txt}
\medskip
\phantomsection\label{code:47:27}
\subsection*{代码清单 A.47.27（text，8 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-027.txt}
\medskip
\phantomsection\label{code:47:28}
\subsection*{代码清单 A.47.28（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-028.txt}
\medskip
\phantomsection\label{code:47:29}
\subsection*{代码清单 A.47.29（text，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-029.txt}
\medskip
\phantomsection\label{code:47:30}
\subsection*{代码清单 A.47.30（text，8 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-030.txt}
\medskip
\phantomsection\label{code:47:31}
\subsection*{代码清单 A.47.31（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-031.txt}
\medskip
\phantomsection\label{code:47:32}
\subsection*{代码清单 A.47.32（text，8 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-032.txt}
\medskip
\phantomsection\label{code:47:33}
\subsection*{代码清单 A.47.33（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-033.txt}
\medskip
\phantomsection\label{code:47:34}
\subsection*{代码清单 A.47.34（text，8 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-034.txt}
\medskip
\phantomsection\label{code:47:35}
\subsection*{代码清单 A.47.35（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-035.txt}
\medskip
\phantomsection\label{code:47:36}
\subsection*{代码清单 A.47.36（text，8 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-036.txt}
\medskip
\phantomsection\label{code:47:37}
\subsection*{代码清单 A.47.37（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-037.txt}
\medskip
\phantomsection\label{code:47:38}
\subsection*{代码清单 A.47.38（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-038.txt}
\medskip
\phantomsection\label{code:47:39}
\subsection*{代码清单 A.47.39（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-039.txt}
\medskip
\phantomsection\label{code:47:40}
\subsection*{代码清单 A.47.40（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-040.txt}
\medskip
\phantomsection\label{code:47:41}
\subsection*{代码清单 A.47.41（text，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-041.txt}
\medskip
\phantomsection\label{code:47:42}
\subsection*{代码清单 A.47.42（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-042.txt}
\medskip
\phantomsection\label{code:47:43}
\subsection*{代码清单 A.47.43（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-043.txt}
\medskip
\phantomsection\label{code:47:44}
\subsection*{代码清单 A.47.44（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-044.txt}
\medskip
\phantomsection\label{code:47:45}
\subsection*{代码清单 A.47.45（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-045.txt}
\medskip
\phantomsection\label{code:47:46}
\subsection*{代码清单 A.47.46（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-046.txt}
\medskip
\phantomsection\label{code:47:47}
\subsection*{代码清单 A.47.47（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-047.txt}
\medskip
\phantomsection\label{code:47:48}
\subsection*{代码清单 A.47.48（text，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-048.txt}
\medskip
\phantomsection\label{code:47:49}
\subsection*{代码清单 A.47.49（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-049.txt}
\medskip
\phantomsection\label{code:47:50}
\subsection*{代码清单 A.47.50（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-050.txt}
\medskip
\phantomsection\label{code:47:51}
\subsection*{代码清单 A.47.51（text，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-051.txt}
\medskip
\phantomsection\label{code:47:52}
\subsection*{代码清单 A.47.52（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-052.txt}
\medskip
\phantomsection\label{code:47:53}
\subsection*{代码清单 A.47.53（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-053.txt}
\medskip
\phantomsection\label{code:47:54}
\subsection*{代码清单 A.47.54（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-054.txt}
\medskip
\phantomsection\label{code:47:55}
\subsection*{代码清单 A.47.55（text，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-055.txt}
\medskip
\phantomsection\label{code:47:56}
\subsection*{代码清单 A.47.56（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-056.txt}
\medskip
\phantomsection\label{code:47:57}
\subsection*{代码清单 A.47.57（text，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-057.txt}
\medskip
\phantomsection\label{code:47:58}
\subsection*{代码清单 A.47.58（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-058.txt}
\medskip
\phantomsection\label{code:47:59}
\subsection*{代码清单 A.47.59（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-059.txt}
\medskip
\phantomsection\label{code:47:60}
\subsection*{代码清单 A.47.60（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-060.txt}
\medskip
\phantomsection\label{code:47:61}
\subsection*{代码清单 A.47.61（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-061.txt}
\medskip
\phantomsection\label{code:47:62}
\subsection*{代码清单 A.47.62（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-062.txt}
\medskip
\phantomsection\label{code:47:63}
\subsection*{代码清单 A.47.63（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-063.txt}
\medskip
\phantomsection\label{code:47:64}
\subsection*{代码清单 A.47.64（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-064.txt}
\medskip
\phantomsection\label{code:47:65}
\subsection*{代码清单 A.47.65（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-065.txt}
\medskip
\phantomsection\label{code:47:66}
\subsection*{代码清单 A.47.66（text，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-066.txt}
\medskip
\phantomsection\label{code:47:67}
\subsection*{代码清单 A.47.67（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-067.txt}
\medskip
\phantomsection\label{code:47:68}
\subsection*{代码清单 A.47.68（text，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-068.txt}
\medskip
\phantomsection\label{code:47:69}
\subsection*{代码清单 A.47.69（text，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-069.txt}
\medskip
\phantomsection\label{code:47:70}
\subsection*{代码清单 A.47.70（text，27 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-070.txt}
\medskip
\phantomsection\label{code:47:71}
\subsection*{代码清单 A.47.71（text，7 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/047-071.txt}
\medskip
\section*{FES体系自旋陈数、金属性阻碍与相界代码}
\phantomsection\label{code:48:1}
\subsection*{代码清单 A.48.1（python，1175 行）}
...
\subsection*{代码清单 A.48.2（python，1450 行）}
...
\subsection*{代码清单 A.48.3（python，1008 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/048-003.py}
\medskip
\phantomsection\label{code:48:4}
\subsection*{代码清单 A.48.4（python，937 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/048-004.py}
\medskip
\phantomsection\label{code:48:5}
\subsection*{代码清单 A.48.5（python，1226 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/048-005.py}
\medskip
\phantomsection\label{code:48:6}
\subsection*{代码清单 A.48.6（python，874 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/048-006.py}
\medskip
\phantomsection\label{code:48:7}
\subsection*{代码清单 A.48.7（python，1058 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/048-007.py}
\medskip
\phantomsection\label{code:48:8}
\subsection*{代码清单 A.48.8（python，792 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/048-008.py}
\medskip
\section*{Lieb体系自旋陈数、解析质量与相界代码}
\phantomsection\label{code:49:1}
\subsection*{代码清单 A.49.1（python，2866 行）}
...
\subsection*{代码清单 A.49.2（python，886 行）}
...
\subsection*{代码清单 A.49.3（python，518 行）}
...
\subsection*{代码清单 A.50.1（python，1066 行）}
...
\subsection*{代码清单 A.50.2（python，1489 行）}
...
\subsection*{代码清单 A.50.3（python，1790 行）}
...
\subsection*{代码清单 A.50.4（python，1294 行）}
...
\subsection*{代码清单 A.50.5（python，1492 行）}
...
\subsection*{代码清单 A.50.6（python，1166 行）}
...
\subsection*{代码清单 A.50.7（python，1360 行）}
...
\subsection*{代码清单 A.51.1（python，1641 行）}
...
\subsection*{代码清单 A.51.2（python，1603 行）}
...
\subsection*{代码清单 A.51.3（python，1738 行）}
...
\subsection*{代码清单 A.51.4（python，1200 行）}
...
\subsection*{代码清单 A.51.5（python，1211 行）}
...
\subsection*{代码清单 A.51.6（python，901 行）}
...
\subsection*{代码清单 A.51.7（python，674 行）}
...
\subsection*{代码清单 A.51.8（python，819 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/051-008.py}
\medskip
\section*{三体系体能带、边缘态、Berry曲率与霍尔响应代码}
\phantomsection\label{code:52:1}
\subsection*{代码清单 A.52.1（python，1892 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/052-001.py}
\medskip
\phantomsection\label{code:52:2}
\subsection*{代码清单 A.52.2（python，1984 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/052-002.py}
\medskip
\phantomsection\label{code:52:3}
\subsection*{代码清单 A.52.3（python，914 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/052-003.py}
\medskip
\phantomsection\label{code:52:4}
\subsection*{代码清单 A.52.4（python，420 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/052-004.py}
\medskip
\phantomsection\label{code:52:5}
\subsection*{代码清单 A.52.5（python，179 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/052-005.py}
\medskip
\phantomsection\label{code:52:6}
\subsection*{代码清单 A.52.6（python，301 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/052-006.py}
\medskip
\phantomsection\label{code:52:7}
\subsection*{代码清单 A.52.7（python，579 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/052-007.py}
\medskip
\phantomsection\label{code:52:8}
\subsection*{代码清单 A.52.8（python，230 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/052-008.py}
\medskip
\section*{堆叠诱导的II型量子自旋霍尔绝缘体在非传统磁性中的高自旋陈数}
\phantomsection\label{code:54:1}
\subsection*{代码清单 A.54.1（plaintext，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/054-001.txt}
\medskip
\section*{kp构造对称哈密顿量的测试}
\phantomsection\label{code:55:1}
\subsection*{代码清单 A.55.1（plaintext，10 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/055-001.txt}
\medskip
\section*{(原创脚本)基于对称性构造TB模型(n带紧束缚模型)——边缘态计算与拟合}
\phantomsection\label{code:56:1}
\subsection*{代码清单 A.56.1（python，24 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/056-001.py}
\medskip
\phantomsection\label{code:56:2}
\subsection*{代码清单 A.56.2（python，13 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/056-002.py}
\medskip
\phantomsection\label{code:56:3}
\subsection*{代码清单 A.56.3（python，20 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/056-003.py}
\medskip
\phantomsection\label{code:56:4}
\subsection*{代码清单 A.56.4（python，28 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/056-004.py}
\medskip
\phantomsection\label{code:56:5}
\subsection*{代码清单 A.56.5（python，103 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/056-005.py}
\medskip
\phantomsection\label{code:56:6}
\subsection*{代码清单 A.56.6（python，10 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/056-006.py}
\medskip
\phantomsection\label{code:56:7}
\subsection*{代码清单 A.56.7（python，10 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/056-007.py}
\medskip
\phantomsection\label{code:56:8}
\subsection*{代码清单 A.56.8（python，664 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/056-008.py}
\medskip
\section*{(原创自研)利用wannier验证超超交换路径}
\phantomsection\label{code:59:1}
\subsection*{代码清单 A.59.1（python，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/059-001.py}
\medskip
\phantomsection\label{code:59:2}
\subsection*{代码清单 A.59.2（python，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/059-002.py}
\medskip
\phantomsection\label{code:59:3}
\subsection*{代码清单 A.59.3（python，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/059-003.py}
\medskip
\phantomsection\label{code:59:4}
\subsection*{代码清单 A.59.4（python，358 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/059-004.py}
\medskip
\phantomsection\label{code:59:5}
\subsection*{代码清单 A.59.5（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/059-005.sh}
\medskip
\phantomsection\label{code:59:6}
\subsection*{代码清单 A.59.6（python，272 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/059-006.py}
\medskip
\phantomsection\label{code:59:7}
\subsection*{代码清单 A.59.7（shell，7 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/059-007.sh}
\medskip
\phantomsection\label{code:59:8}
\subsection*{代码清单 A.59.8（shell，8 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/059-008.sh}
\medskip
\phantomsection\label{code:59:9}
\subsection*{代码清单 A.59.9（python，266 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/059-009.py}
\medskip
\phantomsection\label{code:59:10}
\subsection*{代码清单 A.59.10（shell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/059-010.sh}
\medskip
\phantomsection\label{code:59:11}
\subsection*{代码清单 A.59.11（shell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/059-011.sh}
\medskip
\phantomsection\label{code:59:12}
\subsection*{代码清单 A.59.12（python，225 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/059-012.py}
\medskip
\phantomsection\label{code:59:13}
\subsection*{代码清单 A.59.13（python，47 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/059-013.py}
\medskip
\phantomsection\label{code:59:14}
\subsection*{代码清单 A.59.14（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/059-014.sh}
\medskip
\phantomsection\label{code:59:15}
\subsection*{代码清单 A.59.15（shell，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/059-015.sh}
\medskip
\phantomsection\label{code:59:16}
\subsection*{代码清单 A.59.16（shell，7 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/059-016.sh}
\medskip
\phantomsection\label{code:59:17}
\subsection*{代码清单 A.59.17（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/059-017.sh}
\medskip
\phantomsection\label{code:59:18}
\subsection*{代码清单 A.59.18（shell，5 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/059-018.sh}
\medskip
\section*{(原创自研)利用wannier验证超超交换路径(2)}
\phantomsection\label{code:60:1}
\subsection*{代码清单 A.60.1（python，6 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/060-001.py}
\medskip
\phantomsection\label{code:60:2}
\subsection*{代码清单 A.60.2（python，537 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/060-002.py}
\medskip
\phantomsection\label{code:60:3}
\subsection*{代码清单 A.60.3（python，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/060-003.py}
\medskip
\phantomsection\label{code:60:4}
\subsection*{代码清单 A.60.4（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/060-004.sh}
\medskip
\phantomsection\label{code:60:5}
\subsection*{代码清单 A.60.5（python，431 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/060-005.py}
\medskip
\phantomsection\label{code:60:6}
\subsection*{代码清单 A.60.6（python，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/060-006.py}
\medskip
\section*{(原创自研)利用wannier验证超超交换路径(3)}
\phantomsection\label{code:61:1}
\subsection*{代码清单 A.61.1（shell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/061-001.sh}
\medskip
\phantomsection\label{code:61:2}
\subsection*{代码清单 A.61.2（python，403 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/061-002.py}
\medskip
\phantomsection\label{code:61:3}
\subsection*{代码清单 A.61.3（python，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/061-003.py}
\medskip
\phantomsection\label{code:61:4}
\subsection*{代码清单 A.61.4（python，387 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/061-004.py}
\medskip
\phantomsection\label{code:61:5}
\subsection*{代码清单 A.61.5（python，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/061-005.py}
\medskip
\phantomsection\label{code:61:6}
\subsection*{代码清单 A.61.6（python，472 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/061-006.py}
\medskip
\phantomsection\label{code:61:7}
\subsection*{代码清单 A.61.7（python，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/061-007.py}
\medskip
\phantomsection\label{code:61:8}
\subsection*{代码清单 A.61.8（python，140 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/061-008.py}
\medskip
\phantomsection\label{code:61:9}
\subsection*{代码清单 A.61.9（python，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/061-009.py}
\medskip
\phantomsection\label{code:61:10}
\subsection*{代码清单 A.61.10（python，2 行）}
...
\subsection*{代码清单 A.61.11（python，87 行）}
...
\subsection*{代码清单 A.61.12（python，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/061-012.py}
\medskip
\phantomsection\label{code:61:13}
\subsection*{代码清单 A.61.13（python，122 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/061-013.py}
\medskip
\phantomsection\label{code:61:14}
\subsection*{代码清单 A.61.14（python，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/061-014.py}
\medskip
\section*{(原创自研)利用PDOS验证超超交换路径}
\phantomsection\label{code:62:1}
\subsection*{代码清单 A.62.1（python，298 行）}
...
\subsection*{代码清单 A.62.2（shell，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/062-002.sh}
\medskip
\section*{(原创自研)利用wannier验证超超交换路径(4)}
\phantomsection\label{code:63:1}
\subsection*{代码清单 A.63.1（shell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/063-001.sh}
\medskip
\phantomsection\label{code:63:2}
\subsection*{代码清单 A.63.2（python，351 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/063-002.py}
\medskip
\phantomsection\label{code:63:3}
\subsection*{代码清单 A.63.3（shell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/063-003.sh}
\medskip
\phantomsection\label{code:63:4}
\subsection*{代码清单 A.63.4（python，96 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/063-004.py}
\medskip
\phantomsection\label{code:63:5}
\subsection*{代码清单 A.63.5（python，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/063-005.py}
\medskip
\phantomsection\label{code:63:6}
\subsection*{代码清单 A.63.6（python，270 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/063-006.py}
\medskip
\phantomsection\label{code:63:7}
\subsection*{代码清单 A.63.7（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/063-007.sh}
\medskip
\phantomsection\label{code:63:8}
\subsection*{代码清单 A.63.8（python，120 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/063-008.py}
\medskip
\phantomsection\label{code:63:9}
\subsection*{代码清单 A.63.9（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/063-009.sh}
\medskip
\phantomsection\label{code:63:10}
\subsection*{代码清单 A.63.10（python，89 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/063-010.py}
\medskip
\phantomsection\label{code:63:11}
\subsection*{代码清单 A.63.11（python，85 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/063-011.py}
\medskip
\phantomsection\label{code:63:12}
\subsection*{代码清单 A.63.12（shell，11 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/063-012.sh}
\medskip
\phantomsection\label{code:63:13}
\subsection*{代码清单 A.63.13（python，584 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/063-013.py}
\medskip
\phantomsection\label{code:63:14}
\subsection*{代码清单 A.63.14（shell，4 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/063-014.sh}
\medskip
\phantomsection\label{code:63:15}
\subsection*{代码清单 A.63.15（python，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/063-015.py}
\medskip
\phantomsection\label{code:63:16}
\subsection*{代码清单 A.63.16（python，122 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/063-016.py}
\medskip
\phantomsection\label{code:63:17}
\subsection*{代码清单 A.63.17（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/063-017.sh}
\medskip
\phantomsection\label{code:63:18}
\subsection*{代码清单 A.63.18（python，209 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/063-018.py}
\medskip
\phantomsection\label{code:63:19}
\subsection*{代码清单 A.63.19（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/063-019.sh}
\medskip
\section*{(原创自研)利用wannier计算超超交换过程中的轨道杂化}
\phantomsection\label{code:64:1}
\subsection*{代码清单 A.64.1（python，376 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/064-001.py}
\medskip
\phantomsection\label{code:64:2}
\subsection*{代码清单 A.64.2（shell，9 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/064-002.sh}
\medskip
\phantomsection\label{code:64:3}
\subsection*{代码清单 A.64.3（python，362 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/064-003.py}
\medskip
\phantomsection\label{code:64:4}
\subsection*{代码清单 A.64.4（shell，9 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/064-004.sh}
\medskip
\phantomsection\label{code:64:5}
\subsection*{代码清单 A.64.5（python，385 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/064-005.py}
\medskip
\phantomsection\label{code:64:6}
\subsection*{代码清单 A.64.6（shell，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/064-006.sh}
\medskip
\section*{(原创脚本)任意体系的磁参数J的磁构型设计与计算}
\phantomsection\label{code:70:1}
\subsection*{代码清单 A.70.1（python，677 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/070-001.py}
\medskip
\phantomsection\label{code:70:2}
\subsection*{代码清单 A.70.2（shell，8 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/070-002.sh}
\medskip
\phantomsection\label{code:70:3}
\subsection*{代码清单 A.70.3（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/070-003.sh}
\medskip
\section*{高通量结构优化脚本}
\phantomsection\label{code:71:1}
\subsection*{代码清单 A.71.1（shell，30 行）}
...
\subsection*{代码清单 A.71.2（python，75 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/071-002.py}
\medskip
\phantomsection\label{code:71:3}
\subsection*{代码清单 A.71.3（shell，59 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/071-003.sh}
\medskip
\phantomsection\label{code:71:4}
\subsection*{代码清单 A.71.4（shell，76 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/071-004.sh}
\medskip
\phantomsection\label{code:71:5}
\subsection*{代码清单 A.71.5（shell，172 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/071-005.sh}
\medskip
\section*{通过能带判断缺陷、团簇的python脚本}
\phantomsection\label{code:72:1}
\subsection*{代码清单 A.72.1（python，11 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/072-001.py}
\medskip
\section*{高通量DMI计算脚本}
\phantomsection\label{code:73:1}
\subsection*{代码清单 A.73.1（shell，303 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/073-001.sh}
\medskip
\phantomsection\label{code:73:2}
\subsection*{代码清单 A.73.2（python，113 行）}
...
\subsection*{代码清单 A.74.1（shell，121 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/074-001.sh}
\medskip
\section*{二维双层转角材料的代码构建}
\phantomsection\label{code:75:1}
\subsection*{代码清单 A.75.1（python，21 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/075-001.py}
\medskip
\phantomsection\label{code:75:2}
\subsection*{代码清单 A.75.2（python，557 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/075-002.py}
\medskip
\section*{(改编脚本)快速计算投影能带}
\phantomsection\label{code:76:1}
\subsection*{代码清单 A.76.1（python，652 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/076-001.py}
\medskip
\phantomsection\label{code:76:2}
\subsection*{代码清单 A.76.2（python，622 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/076-002.py}
\medskip
\phantomsection\label{code:76:3}
\subsection*{代码清单 A.76.3（shell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/076-003.sh}
\medskip
\phantomsection\label{code:76:4}
\subsection*{代码清单 A.76.4（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/076-004.sh}
\medskip
\section*{(原创脚本)python解线性方程组}
\phantomsection\label{code:77:1}
\subsection*{代码清单 A.77.1（python，26 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/077-001.py}
\medskip
\section*{(改编脚本)快速绘制轨道投影能带}
\phantomsection\label{code:78:1}
\subsection*{代码清单 A.78.1（shell，4 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/078-001.sh}
\medskip
\phantomsection\label{code:78:2}
\subsection*{代码清单 A.78.2（shell，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/078-002.sh}
\medskip
\phantomsection\label{code:78:3}
\subsection*{代码清单 A.78.3（shell，6 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/078-003.sh}
\medskip
\phantomsection\label{code:78:4}
\subsection*{代码清单 A.78.4（shell，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/078-004.sh}
\medskip
\phantomsection\label{code:78:5}
\subsection*{代码清单 A.78.5（python，28 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/078-005.py}
\medskip
\phantomsection\label{code:78:6}
\subsection*{代码清单 A.78.6（shell，13 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/078-006.sh}
\medskip
\phantomsection\label{code:78:7}
\subsection*{代码清单 A.78.7（shell，11 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/078-007.sh}
\medskip
\phantomsection\label{code:78:8}
\subsection*{代码清单 A.78.8（python，119 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/078-008.py}
\medskip
\phantomsection\label{code:78:9}
\subsection*{代码清单 A.78.9（python，186 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/078-009.py}
\medskip
\phantomsection\label{code:78:10}
\subsection*{代码清单 A.78.10（python，195 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/078-010.py}
\medskip
\phantomsection\label{code:78:11}
\subsection*{代码清单 A.78.11（python，128 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/078-011.py}
\medskip
\section*{(原创脚本)Pyprocar绘制能带图}
\phantomsection\label{code:79:1}
\subsection*{代码清单 A.79.1（python，89 行）}
...
\subsection*{代码清单 A.80.1（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/080-001.sh}
\medskip
\phantomsection\label{code:80:2}
\subsection*{代码清单 A.80.2（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/080-002.sh}
\medskip
\phantomsection\label{code:80:3}
\subsection*{代码清单 A.80.3（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/080-003.sh}
\medskip
\phantomsection\label{code:80:4}
\subsection*{代码清单 A.80.4（shell，7 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/080-004.sh}
\medskip
\phantomsection\label{code:80:5}
\subsection*{代码清单 A.80.5（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/080-005.sh}
\medskip
\phantomsection\label{code:80:6}
\subsection*{代码清单 A.80.6（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/080-006.sh}
\medskip
\section*{(原创脚本)绘制精美的投影能带图}
\phantomsection\label{code:81:1}
\subsection*{代码清单 A.81.1（python，425 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/081-001.py}
\medskip
\phantomsection\label{code:81:2}
\subsection*{代码清单 A.81.2（shell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/081-002.sh}
\medskip
\phantomsection\label{code:81:3}
\subsection*{代码清单 A.81.3（python，488 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/081-003.py}
\medskip
\phantomsection\label{code:81:4}
\subsection*{代码清单 A.81.4（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/081-004.sh}
\medskip
\phantomsection\label{code:81:5}
\subsection*{代码清单 A.81.5（python，482 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/081-005.py}
\medskip
\phantomsection\label{code:81:6}
\subsection*{代码清单 A.81.6（python，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/081-006.py}
\medskip
\phantomsection\label{code:81:7}
\subsection*{代码清单 A.81.7（python，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/081-007.py}
\medskip
\phantomsection\label{code:81:8}
\subsection*{代码清单 A.81.8（python，523 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/081-008.py}
\medskip
\section*{绘制3DMAE的流程(原创脚本与流程)}
\phantomsection\label{code:82:1}
\subsection*{代码清单 A.82.1（python，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/082-001.py}
\medskip
\phantomsection\label{code:82:2}
\subsection*{代码清单 A.82.2（python，38 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/082-002.py}
\medskip
\phantomsection\label{code:82:3}
\subsection*{代码清单 A.82.3（python，33 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/082-003.py}
\medskip
\phantomsection\label{code:82:4}
\subsection*{代码清单 A.82.4（python，63 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/082-004.py}
\medskip
\phantomsection\label{code:82:5}
\subsection*{代码清单 A.82.5（python，85 行）}
...
\subsection*{代码清单 A.84.1（python，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/084-001.py}
\medskip
\phantomsection\label{code:84:2}
\subsection*{代码清单 A.84.2（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/084-002.sh}
\medskip
\phantomsection\label{code:84:3}
\subsection*{代码清单 A.84.3（shell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/084-003.sh}
\medskip
\phantomsection\label{code:84:4}
\subsection*{代码清单 A.84.4（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/084-004.sh}
\medskip
\phantomsection\label{code:84:5}
\subsection*{代码清单 A.84.5（python，56 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/084-005.py}
\medskip
\phantomsection\label{code:84:6}
\subsection*{代码清单 A.84.6（python，58 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/084-006.py}
\medskip
\phantomsection\label{code:84:7}
\subsection*{代码清单 A.84.7（shell，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/084-007.sh}
\medskip
\phantomsection\label{code:84:8}
\subsection*{代码清单 A.84.8（python，24 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/084-008.py}
\medskip
\phantomsection\label{code:84:9}
\subsection*{代码清单 A.84.9（python，13 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/084-009.py}
\medskip
\phantomsection\label{code:84:10}
\subsection*{代码清单 A.84.10（python，20 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/084-010.py}
\medskip
\phantomsection\label{code:84:11}
\subsection*{代码清单 A.84.11（python，9 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/084-011.py}
\medskip
\phantomsection\label{code:84:12}
\subsection*{代码清单 A.84.12（python，229 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/084-012.py}
\medskip
\phantomsection\label{code:84:13}
\subsection*{代码清单 A.84.13（python，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/084-013.py}
\medskip
\phantomsection\label{code:84:14}
\subsection*{代码清单 A.84.14（python，45 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/084-014.py}
\medskip
\phantomsection\label{code:84:15}
\subsection*{代码清单 A.84.15（python，62 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/084-015.py}
\medskip
\phantomsection\label{code:84:16}
\subsection*{代码清单 A.84.16（python，28 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/084-016.py}
\medskip
\phantomsection\label{code:84:17}
\subsection*{代码清单 A.84.17（python，177 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/084-017.py}
\medskip
\phantomsection\label{code:84:18}
\subsection*{代码清单 A.84.18（python，55 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/084-018.py}
\medskip
\phantomsection\label{code:84:19}
\subsection*{代码清单 A.84.19（python，177 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/084-019.py}
\medskip
\section*{(原创脚本)blender绘制斯格明子}
\phantomsection\label{code:85:1}
\subsection*{代码清单 A.85.1（shell，9 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/085-001.sh}
\medskip
\phantomsection\label{code:85:2}
\subsection*{代码清单 A.85.2（python，127 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/085-002.py}
\medskip
\phantomsection\label{code:85:3}
\subsection*{代码清单 A.85.3（python，162 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/085-003.py}
\medskip
\phantomsection\label{code:85:4}
\subsection*{代码清单 A.85.4（python，69 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/085-004.py}
\medskip
\phantomsection\label{code:85:5}
\subsection*{代码清单 A.85.5（shell，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/085-005.sh}
\medskip
\phantomsection\label{code:85:6}
\subsection*{代码清单 A.85.6（python，42 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/085-006.py}
\medskip
\phantomsection\label{code:85:7}
\subsection*{代码清单 A.85.7（python，42 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/085-007.py}
\medskip
\phantomsection\label{code:85:8}
\subsection*{代码清单 A.85.8（shell，4 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/085-008.sh}
\medskip
\phantomsection\label{code:85:9}
\subsection*{代码清单 A.85.9（python，48 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/085-009.py}
\medskip
\phantomsection\label{code:85:10}
\subsection*{代码清单 A.85.10（python，44 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/085-010.py}
\medskip
\phantomsection\label{code:85:11}
\subsection*{代码清单 A.85.11（python，44 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/085-011.py}
\medskip
\phantomsection\label{code:85:12}
\subsection*{代码清单 A.85.12（python，44 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/085-012.py}
\medskip
\section*{(绘图教程) VESTA 到 Blender 的二维材料3D论文原子结构绘图教程}
\phantomsection\label{code:86:1}
\subsection*{代码清单 A.86.1（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-001.txt}
\medskip
\phantomsection\label{code:86:2}
\subsection*{代码清单 A.86.2（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-002.txt}
\medskip
\phantomsection\label{code:86:3}
\subsection*{代码清单 A.86.3（text，9 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-003.txt}
\medskip
\phantomsection\label{code:86:4}
\subsection*{代码清单 A.86.4（text，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-004.txt}
\medskip
\phantomsection\label{code:86:5}
\subsection*{代码清单 A.86.5（text，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-005.txt}
\medskip
\phantomsection\label{code:86:6}
\subsection*{代码清单 A.86.6（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-006.txt}
\medskip
\phantomsection\label{code:86:7}
\subsection*{代码清单 A.86.7（text，11 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-007.txt}
\medskip
\phantomsection\label{code:86:8}
\subsection*{代码清单 A.86.8（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-008.txt}
\medskip
\phantomsection\label{code:86:9}
\subsection*{代码清单 A.86.9（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-009.txt}
\medskip
\phantomsection\label{code:86:10}
\subsection*{代码清单 A.86.10（text，5 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-010.txt}
\medskip
\phantomsection\label{code:86:11}
\subsection*{代码清单 A.86.11（text，3 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-011.txt}
\medskip
\phantomsection\label{code:86:12}
\subsection*{代码清单 A.86.12（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-012.txt}
\medskip
\phantomsection\label{code:86:13}
\subsection*{代码清单 A.86.13（text，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-013.txt}
\medskip
\phantomsection\label{code:86:14}
\subsection*{代码清单 A.86.14（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-014.txt}
\medskip
\phantomsection\label{code:86:15}
\subsection*{代码清单 A.86.15（text，5 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-015.txt}
\medskip
\phantomsection\label{code:86:16}
\subsection*{代码清单 A.86.16（text，5 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-016.txt}
\medskip
\phantomsection\label{code:86:17}
\subsection*{代码清单 A.86.17（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-017.txt}
\medskip
\phantomsection\label{code:86:18}
\subsection*{代码清单 A.86.18（text，5 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-018.txt}
\medskip
\phantomsection\label{code:86:19}
\subsection*{代码清单 A.86.19（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-019.txt}
\medskip
\phantomsection\label{code:86:20}
\subsection*{代码清单 A.86.20（text，5 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-020.txt}
\medskip
\phantomsection\label{code:86:21}
\subsection*{代码清单 A.86.21（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-021.txt}
\medskip
\phantomsection\label{code:86:22}
\subsection*{代码清单 A.86.22（text，5 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-022.txt}
\medskip
\phantomsection\label{code:86:23}
\subsection*{代码清单 A.86.23（text，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-023.txt}
\medskip
\phantomsection\label{code:86:24}
\subsection*{代码清单 A.86.24（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-024.txt}
\medskip
\phantomsection\label{code:86:25}
\subsection*{代码清单 A.86.25（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-025.txt}
\medskip
\phantomsection\label{code:86:26}
\subsection*{代码清单 A.86.26（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-026.txt}
\medskip
\phantomsection\label{code:86:27}
\subsection*{代码清单 A.86.27（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-027.txt}
\medskip
\phantomsection\label{code:86:28}
\subsection*{代码清单 A.86.28（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-028.txt}
\medskip
\phantomsection\label{code:86:29}
\subsection*{代码清单 A.86.29（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-029.txt}
\medskip
\phantomsection\label{code:86:30}
\subsection*{代码清单 A.86.30（text，5 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-030.txt}
\medskip
\phantomsection\label{code:86:31}
\subsection*{代码清单 A.86.31（text，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-031.txt}
\medskip
\phantomsection\label{code:86:32}
\subsection*{代码清单 A.86.32（text，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-032.txt}
\medskip
\phantomsection\label{code:86:33}
\subsection*{代码清单 A.86.33（text，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-033.txt}
\medskip
\phantomsection\label{code:86:34}
\subsection*{代码清单 A.86.34（text，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-034.txt}
\medskip
\phantomsection\label{code:86:35}
\subsection*{代码清单 A.86.35（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-035.txt}
\medskip
\phantomsection\label{code:86:36}
\subsection*{代码清单 A.86.36（text，2 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-036.txt}
\medskip
\phantomsection\label{code:86:37}
\subsection*{代码清单 A.86.37（text，5 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-037.txt}
\medskip
\phantomsection\label{code:86:38}
\subsection*{代码清单 A.86.38（text，8 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-038.txt}
\medskip
\phantomsection\label{code:86:39}
\subsection*{代码清单 A.86.39（text，21 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-039.txt}
\medskip
\phantomsection\label{code:86:40}
\subsection*{代码清单 A.86.40（text，8 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-040.txt}
\medskip
\phantomsection\label{code:86:41}
\subsection*{代码清单 A.86.41（text，1 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/086-041.txt}
\medskip
\section*{复现文献中材料结构的心得}
\phantomsection\label{code:87:1}
\subsection*{代码清单 A.87.1（python，197 行）}
\VerbatimInput[fontsize=\scriptsize,breaklines=true,breakanywhere=true,tabsize=2]{code/087-001.py}
\medskip
\end{document}